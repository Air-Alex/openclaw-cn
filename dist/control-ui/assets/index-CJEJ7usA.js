...
`}function ar(e,t,n){if(t.length===0)return;let s=e;for(let a=0;a<t.length-1;a+=1){const o=t[a],l=t[a+1];if(typeof o=="number"){if(!Array.isArray(s))return;s[o]==null&&(s[o]=typeof l=="number"?[]:{}),s=s[o]}else{if(typeof s!="object"||s==null)return;const c=s;c[o]==null&&(c[o]=typeof l=="number"?[]:{}),s=c[o]}}const i=t[t.length-1];if(typeof i=="number"){Array.isArray(s)&&(s[i]=n);return}typeof s=="object"&&s!=null&&(s[i]=n)}function or(e,t){if(t.length===0)return;let n=e;for(let i=0;i<t.length-1;i+=1){const a=t[i];if(typeof a=="number"){if(!Array.isArray(n))return;n=n[a]}else{if(typeof n!="object"||n==null)return;n=n[a]}if(n==null)return}const s=t[t.length-1];if(typeof s=="number"){Array.isArray(n)&&n.splice(s,1);return}typeof n=="object"&&n!=null&&delete n[s]}async function Ee(e){if(!(!e.client||!e.connected)){e.configLoading=!0,e.lastError=null;try{const t=await e.client.request("config.get",{});Sc(e,t)}catch(t){e.lastError=String(t)}finally{e.configLoading=!1}}}async function rr(e){if(!(!e.client||!e.connected)&&!e.configSchemaLoading){e.configSchemaLoading=!0;try{const t=await e.client.request("config.schema",{});kc(e,t)}catch(t){e.lastError=String(t)}finally{e.configSchemaLoading=!1}}}function kc(e,t){e.configSchema=t.schema??null,e.configUiHints=t.uiHints??{},e.configSchemaVersion=t.version??null}function Sc(e,t){e.configSnapshot=t;const n=typeof t.raw=="string"?t.raw:t.config&&typeof t.config=="object"?_t(t.config):e.configRaw;!e.configFormDirty||e.configFormMode==="raw"?e.configRaw=n:e.configForm?e.configRaw=_t(e.configForm):e.configRaw=n,e.configValid=typeof t.valid=="boolean"?t.valid:null,e.configIssues=Array.isArray(t.issues)?t.issues:[],e.configFormDirty||(e.configForm=gt(t.config??{}),e.configFormOriginal=gt(t.config??{}),e.configRawOriginal=n)}async function En(e){if(!(!e.client||!e.connected)){e.configSaving=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?_t(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.set",{raw:t,baseHash:n}),e.configFormDirty=!1,await Ee(e)}catch(t){e.lastError=String(t)}finally{e.configSaving=!1}}}async function Ac(e){if(!(!e.client||!e.connected)){e.configApplying=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?_t(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.apply",{raw:t,baseHash:n,sessionKey:e.applySessionKey}),e.configFormDirty=!1,await Ee(e)}catch(t){e.lastError=String(t)}finally{e.configApplying=!1}}}async function Cc(e){if(!(!e.client||!e.connected)){e.updateRunning=!0,e.lastError=null;try{await e.client.request("update.run",{sessionKey:e.applySessionKey})}catch(t){e.lastError=String(t)}finally{e.updateRunning=!1}}}function $e(e,t,n){const s=gt(e.configForm??e.configSnapshot?.config??{});ar(s,t,n),e.configForm=s,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=_t(s))}function Ue(e,t){const n=gt(e.configForm??e.configSnapshot?.config??{});or(n,t),e.configForm=n,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=_t(n))}function Tc(e){const{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function _c(e){const{state:t,callbacks:n,accountId:s}=e,i=Tc(t),a=(l,c,u={})=>{const{type:p="text",placeholder:g,maxLength:h,help:f}=u,d=t.values[l]??"",v=t.fieldErrors[l],$=`nostr-profile-${l}`;return p==="textarea"?r`
        <div class="form-field" style="margin-bottom: 12px;">
          ...
          <textarea
            ...
            @input=${x=>{const y=x.target;n.onFieldChange(l,y.value)}}
            ?disabled=${t.saving}
          ></textarea>
...
`],{type:"text/plain"}),s=URL.createObjectURL(n),i=document.createElement("a"),a=new Date().toISOString().slice(0,19).replace(/[:T]/g,"-");i.href=s,i.download=`openclaw-logs-${t}-${a}.log`,i.click(),URL.revokeObjectURL(s)}function bd(e){if(typeof ResizeObserver>"u")return;const t=e.querySelector(".topbar");if(!t)return;const n=()=>{const{height:s}=t.getBoundingClientRect();e.style.setProperty("--topbar-height",`${s}px`)};n(),e.topbarObserver=new ResizeObserver(()=>n()),e.topbarObserver.observe(t)}const yd=2e3,xd=new Set(["trace","debug","info","warn","error","fatal"]);function $d(e){if(typeof e!="string")return null;const t=e.trim();if(!t.startsWith("{")||!t.endsWith("}"))return null;try{const n=JSON.parse(t);return!n||typeof n!="object"?null:n}catch{return null}}function wd(e){if(typeof e!="string")return null;const t=e.toLowerCase();return xd.has(t)?t:null}function kd(e){if(!e.trim())return{raw:e,message:e};try{const t=JSON.parse(e),n=t&&typeof t._meta=="object"&&t._meta!==null?t._meta:null,s=typeof t.time=="string"?t.time:typeof n?.date=="string"?n?.date:null,i=wd(n?.logLevelName??n?.level),a=typeof t[0]=="string"?t[0]:typeof n?.name=="string"?n?.name:null,o=$d(a);let l=null;o&&(typeof o.subsystem=="string"?l=o.subsystem:typeof o.module=="string"&&(l=o.module)),!l&&a&&a.length<120&&(l=a);let c=null;return typeof t[1]=="string"?c=t[1]:!o&&typeof t[0]=="string"?c=t[0]:typeof t.message=="string"&&(c=t.message),{raw:e,time:s,level:i,subsystem:l,message:c??e,meta:n??void 0}}catch{return{raw:e,message:e}}}async function Ci(e,t){if(!(!e.client||!e.connected)&&!(e.logsLoading&&!t?.quiet)){t?.quiet||(e.logsLoading=!0),e.logsError=null;try{const s=await e.client.request("logs.tail",{cursor:t?.reset?void 0:e.logsCursor??void 0,limit:e.logsLimit,maxBytes:e.logsMaxBytes}),a=(Array.isArray(s.lines)?s.lines.filter(l=>typeof l=="string"):[]).map(kd),o=!!(t?.reset||s.reset||e.logsCursor==null);e.logsEntries=o?a:[...e.logsEntries,...a].slice(-yd),typeof s.cursor=="number"&&(e.logsCursor=s.cursor),typeof s.file=="string"&&(e.logsFile=s.file),e.logsTruncated=!!s.truncated,e.logsLastFetchAt=Date.now()}catch(n){e.logsError=String(n)}finally{t?.quiet||(e.logsLoading=!1)}}}async function Qn(e,t){if(!(!e.client||!e.connected)&&!e.nodesLoading){e.nodesLoading=!0,t?.quiet||(e.lastError=null);try{const n=await e.client.request("node.list",{});e.nodes=Array.isArray(n.nodes)?n.nodes:[]}catch(n){t?.quiet||(e.lastError=String(n))}finally{e.nodesLoading=!1}}}async function Yn(e){if(!(!e.client||!e.connected)&&!e.debugLoading){e.debugLoading=!0;try{const[t,n,s,i]=await Promise.all([e.client.request("status",{}),e.client.request("health",{}),e.client.request("models.list",{}),e.client.request("last-heartbeat",{})]);e.debugStatus=t,e.debugHealth=n;const a=s;e.debugModels=Array.isArray(a?.models)?a?.models:[],e.debugHeartbeat=i}catch(t){e.debugCallError=String(t)}finally{e.debugLoading=!1}}}async function Sd(e){if(!(!e.client||!e.connected)){e.debugCallError=null,e.debugCallResult=null;try{const t=e.debugCallParams.trim()?JSON.parse(e.debugCallParams):{},n=await e.client.request(e.debugCallMethod.trim(),t);e.debugCallResult=JSON.stringify(n,null,2)}catch(t){e.debugCallError=String(t)}}}function Ad(e){e.nodesPollInterval==null&&(e.nodesPollInterval=window.setInterval(()=>{Qn(e,{quiet:!0})},5e3))}function Cd(e){e.nodesPollInterval!=null&&(clearInterval(e.nodesPollInterval),e.nodesPollInterval=null)}function Ti(e){e.logsPollInterval==null&&(e.logsPollInterval=window.setInterval(()=>{e.tab==="logs"&&Ci(e,{quiet:!0})},2e3))}function _i(e){e.logsPollInterval!=null&&(clearInterval(e.logsPollInterval),e.logsPollInterval=null)}function Ei(e){e.debugPollInterval==null&&(e.debugPollInterval=window.setInterval(()=>{e.tab==="debug"&&Yn(e)},3e3))}function Li(e){e.debugPollInterval!=null&&(clearInterval(e.debugPollInterval),e.debugPollInterval=null)}async function hr(e,t){if(!(!e.client||!e.connected||e.agentIdentityLoading)&&!e.agentIdentityById[t]){e.agentIdentityLoading=!0,e.agentIdentityError=null;try{const n=await e.client.request("agent.identity.get",{agentId:t});n&&(e.agentIdentityById={...e.agentIdentityById,[t]:n})}catch(n){e.agentIdentityError=String(n)}finally{e.agentIdentityLoading=!1}}}async function vr(e,t){if(!e.client||!e.connected||e.agentIdentityLoading)return;const n=t.filter(s=>!e.agentIdentityById[s]);if(n.length!==0){e.agentIdentityLoading=!0,e.agentIdentityError=null;try{for(const s of n){const i=await e.client.request("agent.identity.get",{agentId:s});i&&(e.agentIdentityById={...e.agentIdentityById,[s]:i})}}catch(s){e.agentIdentityError=String(s)}finally{e.agentIdentityLoading=!1}}}async function Ln(e,t){if(!(!e.client||!e.connected)&&!e.agentSkillsLoading){e.agentSkillsLoading=!0,e.agentSkillsError=null;try{const n=await e.client.request("skills.status",{agentId:t});n&&(e.agentSkillsReport=n,e.agentSkillsAgentId=t)}catch(n){e.agentSkillsError=String(n)}finally{e.agentSkillsLoading=!1}}}async function Mi(e){if(!(!e.client||!e.connected)&&!e.agentsLoading){e.agentsLoading=!0,e.agentsError=null;try{const t=await e.client.request("agents.list",{});if(t){e.agentsList=t;const n=e.agentsSelectedId,s=t.agents.some(i=>i.id===n);(!n||!s)&&(e.agentsSelectedId=t.defaultId??t.agents[0]?.id??null)}}catch(t){e.agentsError=String(t)}finally{e.agentsLoading=!1}}}async function on(e){if(!(!e.client||!e.connected))try{const t=await e.client.request("cron.status",{});e.cronStatus=t}catch(t){e.cronError=String(t)}}async function Zn(e){if(!(!e.client||!e.connected)&&!e.cronLoading){e.cronLoading=!0,e.cronError=null;try{const t=await e.client.request("cron.list",{includeDisabled:!0});e.cronJobs=Array.isArray(t.jobs)?t.jobs:[]}catch(t){e.cronError=String(t)}finally{e.cronLoading=!1}}}function Td(e){if(e.scheduleKind==="at"){const n=Date.parse(e.scheduleAt);if(!Number.isFinite(n))throw new Error("Invalid run time.");return{kind:"at",atMs:n}}if(e.scheduleKind==="every"){const n=Dn(e.everyAmount,0);if(n<=0)throw new Error("Invalid interval amount.");const s=e.everyUnit;return{kind:"every",everyMs:n*(s==="minutes"?6e4:s==="hours"?36e5:864e5)}}const t=e.cronExpr.trim();if(!t)throw new Error("Cron expression required.");return{kind:"cron",expr:t,tz:e.cronTz.trim()||void 0}}function _d(e){if(e.payloadKind==="systemEvent"){const i=e.payloadText.trim();if(!i)throw new Error("System event text required.");return{kind:"systemEvent",text:i}}const t=e.payloadText.trim();if(!t)throw new Error("Agent message required.");const n={kind:"agentTurn",message:t},s=Dn(e.timeoutSeconds,0);return s>0&&(n.timeoutSeconds=s),n}async function Ed(e){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{const t=Td(e.cronForm),n=_d(e.cronForm),s=e.cronForm.sessionTarget==="isolated"&&e.cronForm.payloadKind==="agentTurn"&&e.cronForm.deliveryMode!=="legacy"?{mode:e.cronForm.deliveryMode==="announce"?"announce":e.cronForm.deliveryMode==="deliver"?"deliver":"none",channel:e.cronForm.deliveryChannel.trim()||"last",to:e.cronForm.deliveryTo.trim()||void 0}:void 0,i=e.cronForm.postToMainPrefix.trim()||"Cron",a=e.cronForm.agentId.trim(),o={name:e.cronForm.name.trim(),description:e.cronForm.description.trim()||void 0,agentId:a||void 0,enabled:e.cronForm.enabled,schedule:t,sessionTarget:e.cronForm.sessionTarget,wakeMode:e.cronForm.wakeMode,payload:n,delivery:s,isolation:e.cronForm.sessionTarget==="isolated"&&e.cronForm.deliveryMode==="legacy"?{postToMainPrefix:i}:void 0};if(!o.name)throw new Error("Name required.");await e.client.request("cron.add",o),e.cronForm={...e.cronForm,name:"",description:"",payloadText:""},await Zn(e),await on(e)}catch(t){e.cronError=String(t)}finally{e.cronBusy=!1}}}async function Ld(e,t,n){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{await e.client.request("cron.update",{id:t.id,patch:{enabled:n}}),await Zn(e),await on(e)}catch(s){e.cronError=String(s)}finally{e.cronBusy=!1}}}async function Md(e,t){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{await e.client.request("cron.run",{id:t.id,mode:"force"}),await mr(e,t.id)}catch(n){e.cronError=String(n)}finally{e.cronBusy=!1}}}async function Id(e,t){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{await e.client.request("cron.remove",{id:t.id}),e.cronRunsJobId===t.id&&(e.cronRunsJobId=null,e.cronRuns=[]),await Zn(e),await on(e)}catch(n){e.cronError=String(n)}finally{e.cronBusy=!1}}}async function mr(e,t){if(!(!e.client||!e.connected))try{const n=await e.client.request("cron.runs",{id:t,limit:50});e.cronRunsJobId=t,e.cronRuns=Array.isArray(n.entries)?n.entries:[]}catch(n){e.cronError=String(n)}}const br={p:0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffedn,n:0x1000000000000000000000000000000014def9dea2f79cd65812631a5cf5d3edn,h:8n,a:0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffecn,d:0x52036cee2b6ffe738cc740797779e89800700a4d4141d8ab75eb4dca135978a3n,Gx:0x216936d3cd6e53fec0a4e231fdd6dc5c692cc7609525a7b2c9562d608f25d51an,Gy:0x6666666666666666666666666666666666666666666666666666666666666658n},{p:ue,n:Mn,Gx:ja,Gy:qa,a:ws,d:ks,h:Rd}=br,pt=32,Ii=64,Pd=(...e)=>{"captureStackTrace"in Error&&typeof Error.captureStackTrace=="function"&&Error.captureStackTrace(...e)},oe=(e="")=>{const t=new Error(e);throw Pd(t,oe),t},Dd=e=>typeof e=="bigint",Fd=e=>typeof e=="string",Od=e=>e instanceof Uint8Array||ArrayBuffer.isView(e)&&e.constructor.name==="Uint8Array",Ye=(e,t,n="")=>{const s=Od(e),i=e?.length,a=t!==void 0;if(!s||a&&i!==t){const o=n&&`"${n}" `,l=a?` of length ${t}`:"",c=s?`length=${i}`:`type=${typeof e}`;oe(o+"expected Uint8Array"+l+", got "+c)}return e},Xn=e=>new Uint8Array(e),yr=e=>Uint8Array.from(e),xr=(e,t)=>e.toString(16).padStart(t,"0"),$r=e=>Array.from(Ye(e)).map(t=>xr(t,2)).join(""),He={_0:48,_9:57,A:65,F:70,a:97,f:102},Wa=e=>{if(e>=He._0&&e<=He._9)return e-He._0;if(e>=He.A&&e<=He.F)return e-(He.A-10);if(e>=He.a&&e<=He.f)return e-(He.a-10)},wr=e=>{const t="hex invalid";if(!Fd(e))return oe(t);const n=e.length,s=n/2;if(n%2)return oe(t);const i=Xn(s);for(let a=0,o=0;a<s;a++,o+=2){const l=Wa(e.charCodeAt(o)),c=Wa(e.charCodeAt(o+1));if(l===void 0||c===void 0)return oe(t);i[a]=l*16+c}return i},kr=()=>globalThis?.crypto,Nd=()=>kr()?.subtle??oe("crypto.subtle must be defined, consider polyfill"),tn=(...e)=>{const t=Xn(e.reduce((s,i)=>s+Ye(i).length,0));let n=0;return e.forEach(s=>{t.set(s,n),n+=s.length}),t},Bd=(e=pt)=>kr().getRandomValues(Xn(e)),Fn=BigInt,at=(e,t,n,s="bad number: out of range")=>Dd(e)&&t<=e&&e<n?e:oe(s),D=(e,t=ue)=>{const n=e%t;return n>=0n?n:t+n},Sr=e=>D(e,Mn),zd=(e,t)=>{(e===0n||t<=0n)&&oe("no inverse n="+e+" mod="+t);let n=D(e,t),s=t,i=0n,a=1n;for(;n!==0n;){const o=s/n,l=s%n,c=i-a*o;s=n,n=l,i=a,a=c}return s===1n?D(i,t):oe("no inverse")},Ud=e=>{const t=_r[e];return typeof t!="function"&&oe("hashes."+e+" not set"),t},Ss=e=>e instanceof ke?e:oe("Point expected"),Ys=2n**256n;class ke{static BASE;static ZERO;X;Y;Z;T;constructor(t,n,s,i){const a=Ys;this.X=at(t,0n,a),this.Y=at(n,0n,a),this.Z=at(s,1n,a),this.T=at(i,0n,a),Object.freeze(this)}static CURVE(){return br}static fromAffine(t){return new ke(t.x,t.y,1n,D(t.x*t.y))}static fromBytes(t,n=!1){const s=ks,i=yr(Ye(t,pt)),a=t[31];i[31]=a&-129;const o=Cr(i);at(o,0n,n?Ys:ue);const c=D(o*o),u=D(c-1n),p=D(s*c+1n);let{isValid:g,value:h}=Kd(u,p);g||oe("bad point: y not sqrt");const f=(h&1n)===1n,d=(a&128)!==0;return!n&&h===0n&&d&&oe("bad point: x==0, isLastByteOdd"),d!==f&&(h=D(-h)),new ke(h,o,1n,D(h*o))}static fromHex(t,n){return ke.fromBytes(wr(t),n)}get x(){return this.toAffine().x}get y(){return this.toAffine().y}assertValidity(){const t=ws,n=ks,s=this;if(s.is0())return oe("bad point: ZERO");const{X:i,Y:a,Z:o,T:l}=s,c=D(i*i),u=D(a*a),p=D(o*o),g=D(p*p),h=D(c*t),f=D(p*D(h+u)),d=D(g+D(n*D(c*u)));if(f!==d)return oe("bad point: equation left != right (1)");const v=D(i*a),$=D(o*l);return v!==$?oe("bad point: equation left != right (2)"):this}equals(t){const{X:n,Y:s,Z:i}=this,{X:a,Y:o,Z:l}=Ss(t),c=D(n*l),u=D(a*i),p=D(s*l),g=D(o*i);return c===u&&p===g}is0(){return this.equals(At)}negate(){return new ke(D(-this.X),this.Y,this.Z,D(-this.T))}double(){const{X:t,Y:n,Z:s}=this,i=ws,a=D(t*t),o=D(n*n),l=D(2n*D(s*s)),c=D(i*a),u=t+n,p=D(D(u*u)-a-o),g=c+o,h=g-l,f=c-o,d=D(p*h),v=D(g*f),$=D(p*f),x=D(h*g);return new ke(d,v,x,$)}add(t){const{X:n,Y:s,Z:i,T:a}=this,{X:o,Y:l,Z:c,T:u}=Ss(t),p=ws,g=ks,h=D(n*o),f=D(s*l),d=D(a*g*u),v=D(i*c),$=D((n+s)*(o+l)-h-f),x=D(v-d),y=D(v+d),C=D(f-p*h),A=D($*x),T=D(y*C),_=D($*C),I=D(x*y);return new ke(A,T,I,_)}subtract(t){return this.add(Ss(t).negate())}multiply(t,n=!0){if(!n&&(t===0n||this.is0()))return At;if(at(t,1n,Mn),t===1n)return this;if(this.equals(ft))return eu(t).p;let s=At,i=ft;for(let a=this;t>0n;a=a.double(),t>>=1n)t&1n?s=s.add(a):n&&(i=i.add(a));return s}multiplyUnsafe(t){return this.multiply(t,!1)}toAffine(){const{X:t,Y:n,Z:s}=this;if(this.equals(At))return{x:0n,y:1n};const i=zd(s,ue);D(s*i)!==1n&&oe("invalid inverse");const a=D(t*i),o=D(n*i);return{x:a,y:o}}toBytes(){const{x:t,y:n}=this.assertValidity().toAffine(),s=Ar(n);return s[31]|=t&1n?128:0,s}toHex(){return $r(this.toBytes())}clearCofactor(){return this.multiply(Fn(Rd),!1)}isSmallOrder(){return this.clearCofactor().is0()}isTorsionFree(){let t=this.multiply(Mn/2n,!1).double();return Mn%2n&&(t=t.add(this)),t.is0()}}const ft=new ke(ja,qa,1n,D(ja*qa)),At=new ke(0n,1n,1n,0n);ke.BASE=ft;ke.ZERO=At;const Ar=e=>wr(xr(at(e,0n,Ys),Ii)).reverse(),Cr=e=>Fn("0x"+$r(yr(Ye(e)).reverse())),Ie=(e,t)=>{let n=e;for(;t-- >0n;)n*=n,n%=ue;return n},Hd=e=>{const n=e*e%ue*e%ue,s=Ie(n,2n)*n%ue,i=Ie(s,1n)*e%ue,a=Ie(i,5n)*i%ue,o=Ie(a,10n)*a%ue,l=Ie(o,20n)*o%ue,c=Ie(l,40n)*l%ue,u=Ie(c,80n)*c%ue,p=Ie(u,80n)*c%ue,g=Ie(p,10n)*a%ue;return{pow_p_5_8:Ie(g,2n)*e%ue,b2:n}},Va=0x2b8324804fc1df0b2b4d00993dfbd7a72f431806ad2fe478c4ee1b274a0ea0b0n,Kd=(e,t)=>{const n=D(t*t*t),s=D(n*n*t),i=Hd(e*s).pow_p_5_8;let a=D(e*n*i);const o=D(t*a*a),l=a,c=D(a*Va),u=o===e,p=o===D(-e),g=o===D(-e*Va);return u&&(a=l),(p||g)&&(a=c),(D(a)&1n)===1n&&(a=D(-a)),{isValid:u||p,value:a}},Zs=e=>Sr(Cr(e)),Ri=(...e)=>_r.sha512Async(tn(...e)),jd=(...e)=>Ud("sha512")(tn(...e)),Tr=e=>{const t=e.slice(0,pt);t[0]&=248,t[31]&=127,t[31]|=64;const n=e.slice(pt,Ii),s=Zs(t),i=ft.multiply(s),a=i.toBytes();return{head:t,prefix:n,scalar:s,point:i,pointBytes:a}},Pi=e=>Ri(Ye(e,pt)).then(Tr),qd=e=>Tr(jd(Ye(e,pt))),Wd=e=>Pi(e).then(t=>t.pointBytes),Vd=e=>Ri(e.hashable).then(e.finish),Gd=(e,t,n)=>{const{pointBytes:s,scalar:i}=e,a=Zs(t),o=ft.multiply(a).toBytes();return{hashable:tn(o,s,n),finish:u=>{const p=Sr(a+Zs(u)*i);return Ye(tn(o,Ar(p)),Ii)}}},Qd=async(e,t)=>{const n=Ye(e),s=await Pi(t),i=await Ri(s.prefix,n);return Vd(Gd(s,i,n))},_r={sha512Async:async e=>{const t=Nd(),n=tn(e);return Xn(await t.digest("SHA-512",n.buffer))},sha512:void 0},Yd=(e=Bd(pt))=>e,Zd={getExtendedPublicKeyAsync:Pi,getExtendedPublicKey:qd,randomSecretKey:Yd},On=8,Xd=256,Er=Math.ceil(Xd/On)+1,Xs=2**(On-1),Jd=()=>{const e=[];let t=ft,n=t;for(let s=0;s<Er;s++){n=t,e.push(n);for(let i=1;i<Xs;i++)n=n.add(t),e.push(n);t=n.double()}return e};let Ga;const Qa=(e,t)=>{const n=t.negate();return e?n:t},eu=e=>{const t=Ga||(Ga=Jd());let n=At,s=ft;const i=2**On,a=i,o=Fn(i-1),l=Fn(On);for(let c=0;c<Er;c++){let u=Number(e&o);e>>=l,u>Xs&&(u-=a,e+=1n);const p=c*Xs,g=p,h=p+Math.abs(u)-1,f=c%2!==0,d=u<0;u===0?s=s.add(Qa(f,t[g])):n=n.add(Qa(d,t[h]))}return e!==0n&&oe("invalid wnaf"),{p:n,f:s}},As="clawdbot-device-identity-v1";function Js(e){let t="";for(const n of e)t+=String.fromCharCode(n);return btoa(t).replaceAll("+","-").replaceAll("/","_").replace(/=+$/g,"")}function Lr(e){const t=e.replaceAll("-","+").replaceAll("_","/"),n=t+"=".repeat((4-t.length%4)%4),s=atob(n),i=new Uint8Array(s.length);for(let a=0;a<s.length;a+=1)i[a]=s.charCodeAt(a);return i}function tu(e){return Array.from(e).map(t=>t.toString(16).padStart(2,"0")).join("")}async function Mr(e){const t=await crypto.subtle.digest("SHA-256",e);return tu(new Uint8Array(t))}async function nu(){const e=Zd.randomSecretKey(),t=await Wd(e);return{deviceId:await Mr(t),publicKey:Js(t),privateKey:Js(e)}}async function Di(){try{const n=localStorage.getItem(As);if(n){const s=JSON.parse(n);if(s?.version===1&&typeof s.deviceId=="string"&&typeof s.publicKey=="string"&&typeof s.privateKey=="string"){const i=await Mr(Lr(s.publicKey));if(i!==s.deviceId){const a={...s,deviceId:i};return localStorage.setItem(As,JSON.stringify(a)),{deviceId:i,publicKey:s.publicKey,privateKey:s.privateKey}}return{deviceId:s.deviceId,publicKey:s.publicKey,privateKey:s.privateKey}}}}catch{}const e=await nu(),t={version:1,deviceId:e.deviceId,publicKey:e.publicKey,privateKey:e.privateKey,createdAtMs:Date.now()};return localStorage.setItem(As,JSON.stringify(t)),e}async function su(e,t){const n=Lr(e),s=new TextEncoder().encode(t),i=await Qd(s,n);return Js(i)}const Ir="clawdbot.device.auth.v1";function Fi(e){return e.trim()}function iu(e){if(!Array.isArray(e))return[];const t=new Set;for(const n of e){const s=n.trim();s&&t.add(s)}return[...t].sort()}function Oi(){try{const e=window.localStorage.getItem(Ir);if(!e)return null;const t=JSON.parse(e);return!t||t.version!==1||!t.deviceId||typeof t.deviceId!="string"||!t.tokens||typeof t.tokens!="object"?null:t}catch{return null}}function Rr(e){try{window.localStorage.setItem(Ir,JSON.stringify(e))}catch{}}function au(e){const t=Oi();if(!t||t.deviceId!==e.deviceId)return null;const n=Fi(e.role),s=t.tokens[n];return!s||typeof s.token!="string"?null:s}function Pr(e){const t=Fi(e.role),n={version:1,deviceId:e.deviceId,tokens:{}},s=Oi();s&&s.deviceId===e.deviceId&&(n.tokens={...s.tokens});const i={token:e.token,role:t,scopes:iu(e.scopes),updatedAtMs:Date.now()};return n.tokens[t]=i,Rr(n),i}function Dr(e){const t=Oi();if(!t||t.deviceId!==e.deviceId)return;const n=Fi(e.role);if(!t.tokens[n])return;const s={...t,tokens:{...t.tokens}};delete s.tokens[n],Rr(s)}async function Ze(e,t){if(!(!e.client||!e.connected)&&!e.devicesLoading){e.devicesLoading=!0,t?.quiet||(e.devicesError=null);try{const n=await e.client.request("device.pair.list",{});e.devicesList={pending:Array.isArray(n?.pending)?n.pending:[],paired:Array.isArray(n?.paired)?n.paired:[]}}catch(n){t?.quiet||(e.devicesError=String(n))}finally{e.devicesLoading=!1}}}async function ou(e,t){if(!(!e.client||!e.connected))try{await e.client.request("device.pair.approve",{requestId:t}),await Ze(e)}catch(n){e.devicesError=String(n)}}async function ru(e,t){if(!(!e.client||!e.connected||!window.confirm("Reject this device pairing request?")))try{await e.client.request("device.pair.reject",{requestId:t}),await Ze(e)}catch(s){e.devicesError=String(s)}}async function lu(e,t){if(!(!e.client||!e.connected))try{const n=await e.client.request("device.token.rotate",t);if(n?.token){const s=await Di(),i=n.role??t.role;(n.deviceId===s.deviceId||t.deviceId===s.deviceId)&&Pr({deviceId:s.deviceId,role:i,token:n.token,scopes:n.scopes??t.scopes??[]}),window.prompt("New device token (copy and store securely):",n.token)}await Ze(e)}catch(n){e.devicesError=String(n)}}async function cu(e,t){if(!(!e.client||!e.connected||!window.confirm(`Revoke token for ${t.deviceId} (${t.role})?`)))try{await e.client.request("device.token.revoke",t);const s=await Di();t.deviceId===s.deviceId&&Dr({deviceId:s.deviceId,role:t.role}),await Ze(e)}catch(s){e.devicesError=String(s)}}function du(e){if(!e||e.kind==="gateway")return{method:"exec.approvals.get",params:{}};const t=e.nodeId.trim();return t?{method:"exec.approvals.node.get",params:{nodeId:t}}:null}function uu(e,t){if(!e||e.kind==="gateway")return{method:"exec.approvals.set",params:t};const n=e.nodeId.trim();return n?{method:"exec.approvals.node.set",params:{...t,nodeId:n}}:null}async function Ni(e,t){if(!(!e.client||!e.connected)&&!e.execApprovalsLoading){e.execApprovalsLoading=!0,e.lastError=null;try{const n=du(t);if(!n){e.lastError="Select a node before loading exec approvals.";return}const s=await e.client.request(n.method,n.params);gu(e,s)}catch(n){e.lastError=String(n)}finally{e.execApprovalsLoading=!1}}}function gu(e,t){e.execApprovalsSnapshot=t,e.execApprovalsDirty||(e.execApprovalsForm=gt(t.file??{}))}async function pu(e,t){if(!(!e.client||!e.connected)){e.execApprovalsSaving=!0,e.lastError=null;try{const n=e.execApprovalsSnapshot?.hash;if(!n){e.lastError="Exec approvals hash missing; reload and retry.";return}const s=e.execApprovalsForm??e.execApprovalsSnapshot?.file??{},i=uu(t,{file:s,baseHash:n});if(!i){e.lastError="Select a node before saving exec approvals.";return}await e.client.request(i.method,i.params),e.execApprovalsDirty=!1,await Ni(e,t)}catch(n){e.lastError=String(n)}finally{e.execApprovalsSaving=!1}}}function fu(e,t,n){const s=gt(e.execApprovalsForm??e.execApprovalsSnapshot?.file??{});ar(s,t,n),e.execApprovalsForm=s,e.execApprovalsDirty=!0}function hu(e,t){const n=gt(e.execApprovalsForm??e.execApprovalsSnapshot?.file??{});or(n,t),e.execApprovalsForm=n,e.execApprovalsDirty=!0}async function Bi(e){if(!(!e.client||!e.connected)&&!e.presenceLoading){e.presenceLoading=!0,e.presenceError=null,e.presenceStatus=null;try{const t=await e.client.request("system-presence",{});Array.isArray(t)?(e.presenceEntries=t,e.presenceStatus=t.length===0?"No instances yet.":null):(e.presenceEntries=[],e.presenceStatus="No presence payload.")}catch(t){e.presenceError=String(t)}finally{e.presenceLoading=!1}}}function Et(e,t,n){if(!t.trim())return;const s={...e.skillMessages};n?s[t]=n:delete s[t],e.skillMessages=s}function Jn(e){return e instanceof Error?e.message:String(e)}async function rn(e,t){if(t?.clearMessages&&Object.keys(e.skillMessages).length>0&&(e.skillMessages={}),!(!e.client||!e.connected)&&!e.skillsLoading){e.skillsLoading=!0,e.skillsError=null;try{const n=await e.client.request("skills.status",{});n&&(e.skillsReport=n)}catch(n){e.skillsError=Jn(n)}finally{e.skillsLoading=!1}}}function vu(e,t,n){e.skillEdits={...e.skillEdits,[t]:n}}async function mu(e,t,n){if(!(!e.client||!e.connected)){e.skillsBusyKey=t,e.skillsError=null;try{await e.client.request("skills.update",{skillKey:t,enabled:n}),await rn(e),Et(e,t,{kind:"success",message:n?"Skill enabled":"Skill disabled"})}catch(s){const i=Jn(s);e.skillsError=i,Et(e,t,{kind:"error",message:i})}finally{e.skillsBusyKey=null}}}async function bu(e,t){if(!(!e.client||!e.connected)){e.skillsBusyKey=t,e.skillsError=null;try{const n=e.skillEdits[t]??"";await e.client.request("skills.update",{skillKey:t,apiKey:n}),await rn(e),Et(e,t,{kind:"success",message:"API key saved"})}catch(n){const s=Jn(n);e.skillsError=s,Et(e,t,{kind:"error",message:s})}finally{e.skillsBusyKey=null}}}async function yu(e,t,n,s){if(!(!e.client||!e.connected)){e.skillsBusyKey=t,e.skillsError=null;try{const i=await e.client.request("skills.install",{name:n,installId:s,timeoutMs:12e4});await rn(e),Et(e,t,{kind:"success",message:i?.message??"Installed"})}catch(i){const a=Jn(i);e.skillsError=a,Et(e,t,{kind:"error",message:a})}finally{e.skillsBusyKey=null}}}async function zi(e,t){if(!(!e.client||!e.connected)&&!e.usageLoading){e.usageLoading=!0,e.usageError=null;try{const n=t?.startDate??e.usageStartDate,s=t?.endDate??e.usageEndDate,[i,a]=await Promise.all([e.client.request("sessions.usage",{startDate:n,endDate:s,limit:1e3,includeContextWeight:!0}),e.client.request("usage.cost",{startDate:n,endDate:s})]);i&&(e.usageResult=i),a&&(e.usageCostSummary=a)}catch(n){e.usageError=String(n)}finally{e.usageLoading=!1}}}async function xu(e,t){if(!(!e.client||!e.connected)&&!e.usageTimeSeriesLoading){e.usageTimeSeriesLoading=!0,e.usageTimeSeries=null;try{const n=await e.client.request("sessions.usage.timeseries",{key:t});n&&(e.usageTimeSeries=n)}catch{e.usageTimeSeries=null}finally{e.usageTimeSeriesLoading=!1}}}async function $u(e,t){if(!(!e.client||!e.connected)&&!e.usageSessionLogsLoading){e.usageSessionLogsLoading=!0,e.usageSessionLogs=null;try{const n=await e.client.request("sessions.usage.logs",{key:t,limit:500});n&&Array.isArray(n.logs)&&(e.usageSessionLogs=n.logs)}catch{e.usageSessionLogs=null}finally{e.usageSessionLogsLoading=!1}}}const wu=[{label:"对话",tabs:["chat"]},{label:"控制",tabs:["overview","channels","instances","sessions","usage","cron"]},{label:"代理",tabs:["agents","skills","nodes"]},{label:"设置",tabs:["config","debug","logs"]}],Fr={agents:"/agents",overview:"/overview",channels:"/channels",instances:"/instances",sessions:"/sessions",usage:"/usage",cron:"/cron",skills:"/skills",nodes:"/nodes",chat:"/chat",config:"/config",debug:"/debug",logs:"/logs"},Or=new Map(Object.entries(Fr).map(([e,t])=>[t,e]));function ln(e){if(!e)return"";let t=e.trim();return t.startsWith("/")||(t=`/${t}`),t==="/"?"":(t.endsWith("/")&&(t=t.slice(0,-1)),t)}function nn(e){if(!e)return"/";let t=e.trim();return t.startsWith("/")||(t=`/${t}`),t.length>1&&t.endsWith("/")&&(t=t.slice(0,-1)),t}function Ui(e,t=""){const n=ln(t),s=Fr[e];return n?`${n}${s}`:s}function Nr(e,t=""){const n=ln(t);let s=e||"/";n&&(s===n?s="/":s.startsWith(`${n}/`)&&(s=s.slice(n.length)));let i=nn(s).toLowerCase();return i.endsWith("/index.html")&&(i="/"),i==="/"?"chat":Or.get(i)??null}function ku(e){let t=nn(e);if(t.endsWith("/index.html")&&(t=nn(t.slice(0,-11))),t==="/")return"";const n=t.split("/").filter(Boolean);if(n.length===0)return"";for(let s=0;s<n.length;s++){const i=`/${n.slice(s).join("/")}`.toLowerCase();if(Or.has(i)){const a=n.slice(0,s);return a.length?`/${a.join("/")}`:""}}return`/${n.join("/")}`}function Su(e){switch(e){case"agents":return"folder";case"chat":return"messageSquare";case"overview":return"barChart";case"channels":return"link";case"instances":return"radio";case"sessions":return"fileText";case"usage":return"barChart";case"cron":return"loader";case"skills":return"zap";case"nodes":return"monitor";case"config":return"settings";case"debug":return"bug";case"logs":return"scrollText";default:return"folder"}}function ei(e){switch(e){case"agents":return"代理";case"overview":return"概览";case"channels":return"通道";case"instances":return"实例";case"sessions":return"会话";case"usage":return"用量";case"cron":return"定时任务";case"skills":return"技能";case"nodes":return"节点";case"chat":return"对话";case"config":return"配置";case"debug":return"调试";case"logs":return"日志";default:return"控制"}}function Au(e){switch(e){case"agents":return"管理代理工作区、工具和身份。";case"overview":return"网关状态、入口和快速健康检查。";case"channels":return"管理通道和设置。";case"instances":return"来自已连接客户端和节点的存在信标。";case"sessions":return"查看活跃会话并调整每会话默认设置。";case"usage":return"";case"cron":return"安排唤醒和定期代理运行。";case"skills":return"管理技能可用性和 API 密钥注入。";case"nodes":return"配对设备、功能和命令暴露。";case"chat":return"网关直连对话会话，用于快速操作。";case"config":return"安全编辑 ~/.openclaw/openclaw.json。";case"debug":return"网关快照、事件和手动 RPC 调用。";case"logs":return"实时追踪网关文件日志。";default:return""}}const Br="clawdbot.control.settings.v1";function Cu(){const t={gatewayUrl:`${location.protocol==="https:"?"wss":"ws"}://${location.host}`,token:"",sessionKey:"main",lastActiveSessionKey:"main",theme:"system",chatFocusMode:!1,chatShowThinking:!0,sendOnEnter:!0,splitRatio:.6,navCollapsed:!1,navGroupsCollapsed:{}};try{const n=localStorage.getItem(Br);if(!n)return t;const s=JSON.parse(n);return{gatewayUrl:typeof s.gatewayUrl=="string"&&s.gatewayUrl.trim()?s.gatewayUrl.trim():t.gatewayUrl,token:typeof s.token=="string"?s.token:t.token,sessionKey:typeof s.sessionKey=="string"&&s.sessionKey.trim()?s.sessionKey.trim():t.sessionKey,lastActiveSessionKey:typeof s.lastActiveSessionKey=="string"&&s.lastActiveSessionKey.trim()?s.lastActiveSessionKey.trim():typeof s.sessionKey=="string"&&s.sessionKey.trim()||t.lastActiveSessionKey,theme:s.theme==="light"||s.theme==="dark"||s.theme==="system"?s.theme:t.theme,chatFocusMode:typeof s.chatFocusMode=="boolean"?s.chatFocusMode:t.chatFocusMode,chatShowThinking:typeof s.chatShowThinking=="boolean"?s.chatShowThinking:t.chatShowThinking,sendOnEnter:typeof s.sendOnEnter=="boolean"?s.sendOnEnter:t.sendOnEnter,splitRatio:typeof s.splitRatio=="number"&&s.splitRatio>=.4&&s.splitRatio<=.7?s.splitRatio:t.splitRatio,navCollapsed:typeof s.navCollapsed=="boolean"?s.navCollapsed:t.navCollapsed,navGroupsCollapsed:typeof s.navGroupsCollapsed=="object"&&s.navGroupsCollapsed!==null?s.navGroupsCollapsed:t.navGroupsCollapsed}}catch{return t}}function Tu(e){localStorage.setItem(Br,JSON.stringify(e))}const yn=e=>Number.isNaN(e)?.5:e<=0?0:e>=1?1:e,_u=()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches??!1,xn=e=>{e.classList.remove("theme-transition"),e.style.removeProperty("--theme-switch-x"),e.style.removeProperty("--theme-switch-y")},Eu=({nextTheme:e,applyTheme:t,context:n,currentTheme:s})=>{if(s===e)return;const i=globalThis.document??null;if(!i){t();return}const a=i.documentElement,o=i,l=_u();if(!!o.startViewTransition&&!l){let u=.5,p=.5;if(n?.pointerClientX!==void 0&&n?.pointerClientY!==void 0&&typeof window<"u")u=yn(n.pointerClientX/window.innerWidth),p=yn(n.pointerClientY/window.innerHeight);else if(n?.element){const g=n.element.getBoundingClientRect();g.width>0&&g.height>0&&typeof window<"u"&&(u=yn((g.left+g.width/2)/window.innerWidth),p=yn((g.top+g.height/2)/window.innerHeight))}a.style.setProperty("--theme-switch-x",`${u*100}%`),a.style.setProperty("--theme-switch-y",`${p*100}%`),a.classList.add("theme-transition");try{const g=o.startViewTransition?.(()=>{t()});g?.finished?g.finished.finally(()=>xn(a)):xn(a)}catch{xn(a),t()}return}t(),xn(a)};function Lu(){return typeof window>"u"||typeof window.matchMedia!="function"||window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function Hi(e){return e==="system"?Lu():e}function ht(e,t){const n={...t,lastActiveSessionKey:t.lastActiveSessionKey?.trim()||t.sessionKey.trim()||"main"};e.settings=n,Tu(n),t.theme!==e.theme&&(e.theme=t.theme,es(e,Hi(t.theme))),e.applySessionKey=e.settings.lastActiveSessionKey}function zr(e,t){const n=t.trim();n&&e.settings.lastActiveSessionKey!==n&&ht(e,{...e.settings,lastActiveSessionKey:n})}function Mu(e){if(!window.location.search)return;const t=new URLSearchParams(window.location.search),n=t.get("token"),s=t.get("password"),i=t.get("session"),a=t.get("gatewayUrl");let o=!1;if(n!=null&&(t.delete("token"),o=!0),s!=null){const c=s.trim();c&&(e.password=c),t.delete("password"),o=!0}if(i!=null){const c=i.trim();c&&(e.sessionKey=c,ht(e,{...e.settings,sessionKey:c,lastActiveSessionKey:c}))}if(a!=null){const c=a.trim();c&&c!==e.settings.gatewayUrl&&(e.pendingGatewayUrl=c),t.delete("gatewayUrl"),o=!0}if(!o)return;const l=new URL(window.location.href);l.search=t.toString(),window.history.replaceState({},"",l.toString())}function Iu(e,t){e.tab!==t&&(e.tab=t),t==="chat"&&(e.chatHasAutoScrolled=!1),t==="logs"?Ti(e):_i(e),t==="debug"?Ei(e):Li(e),Ki(e),Hr(e,t,!1)}function Ru(e,t,n){Eu({nextTheme:t,applyTheme:()=>{e.theme=t,ht(e,{...e.settings,theme:t}),es(e,Hi(t))},context:n,currentTheme:e.theme})}async function Ki(e){if(e.tab==="overview"&&await Kr(e),e.tab==="channels"&&await Uu(e),e.tab==="instances"&&await Bi(e),e.tab==="sessions"&&await Mt(e),e.tab==="usage"&&await zi(e),e.tab==="cron"&&await Nn(e),e.tab==="skills"&&await rn(e),e.tab==="agents"){await Mi(e),await Ee(e);const t=e.agentsList?.agents?.map(s=>s.id)??[];t.length>0&&vr(e,t);const n=e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id;n&&(hr(e,n),e.agentsPanel==="skills"&&Ln(e,n),e.agentsPanel==="channels"&&ye(e,!1),e.agentsPanel==="cron"&&Nn(e))}e.tab==="nodes"&&(await Qn(e),await Ze(e),await Ee(e),await Ni(e)),e.tab==="chat"&&(await Qr(e),an(e,!e.chatHasAutoScrolled)),e.tab==="config"&&(await rr(e),await Ee(e)),e.tab==="debug"&&(await Yn(e),e.eventLog=e.eventLogBuffer),e.tab==="logs"&&(e.logsAtBottom=!0,await Ci(e,{reset:!0}),fr(e,!0))}function Pu(){if(typeof window>"u")return"";const e=window.__OPENCLAW_CONTROL_UI_BASE_PATH__;return typeof e=="string"&&e.trim()?ln(e):ku(window.location.pathname)}function Du(e){e.theme=e.settings.theme??"system",es(e,Hi(e.theme))}function es(e,t){if(e.themeResolved=t,typeof document>"u")return;const n=document.documentElement;n.dataset.theme=t,n.style.colorScheme=t}function Fu(e){if(typeof window>"u"||typeof window.matchMedia!="function")return;if(e.themeMedia=window.matchMedia("(prefers-color-scheme: dark)"),e.themeMediaHandler=n=>{e.theme==="system"&&es(e,n.matches?"dark":"light")},typeof e.themeMedia.addEventListener=="function"){e.themeMedia.addEventListener("change",e.themeMediaHandler);return}e.themeMedia.addListener(e.themeMediaHandler)}function Ou(e){if(!e.themeMedia||!e.themeMediaHandler)return;if(typeof e.themeMedia.removeEventListener=="function"){e.themeMedia.removeEventListener("change",e.themeMediaHandler);return}e.themeMedia.removeListener(e.themeMediaHandler),e.themeMedia=null,e.themeMediaHandler=null}function Nu(e,t){if(typeof window>"u")return;const n=Nr(window.location.pathname,e.basePath)??"chat";Ur(e,n),Hr(e,n,t)}function Bu(e){if(typeof window>"u")return;const t=Nr(window.location.pathname,e.basePath);if(!t)return;const s=new URL(window.location.href).searchParams.get("session")?.trim();s&&(e.sessionKey=s,ht(e,{...e.settings,sessionKey:s,lastActiveSessionKey:s})),Ur(e,t)}function Ur(e,t){e.tab!==t&&(e.tab=t),t==="chat"&&(e.chatHasAutoScrolled=!1),t==="logs"?Ti(e):_i(e),t==="debug"?Ei(e):Li(e),e.connected&&Ki(e)}function Hr(e,t,n){if(typeof window>"u")return;const s=nn(Ui(t,e.basePath)),i=nn(window.location.pathname),a=new URL(window.location.href);t==="chat"&&e.sessionKey?a.searchParams.set("session",e.sessionKey):a.searchParams.delete("session"),i!==s&&(a.pathname=s),n?window.history.replaceState({},"",a.toString()):window.history.pushState({},"",a.toString())}function zu(e,t,n){if(typeof window>"u")return;const s=new URL(window.location.href);s.searchParams.set("session",t),window.history.replaceState({},"",s.toString())}async function Kr(e){await Promise.all([ye(e,!1),Bi(e),Mt(e),on(e),Yn(e)])}async function Uu(e){await Promise.all([ye(e,!0),rr(e),Ee(e)])}async function Nn(e){await Promise.all([ye(e,!1),on(e),Zn(e)])}function jr(e){const t=(e??"").trim();if(!t)return null;const n=t.split(":").filter(Boolean);if(n.length<3||n[0]!=="agent")return null;const s=n[1]?.trim(),i=n.slice(2).join(":");return!s||!i?null:{agentId:s,rest:i}}function qr(e){return e.chatSending||!!e.chatRunId}function Hu(e){const t=e.trim();if(!t)return!1;const n=t.toLowerCase();return n==="/stop"?!0:n==="stop"||n==="esc"||n==="abort"||n==="wait"||n==="exit"}async function Wr(e){e.connected&&(e.chatMessage="",await td(e))}function Ku(e,t,n){const s=t.trim(),i=!!(n&&n.length>0);!s&&!i||(e.chatQueue=[...e.chatQueue,{id:Si(),text:s,createdAt:Date.now(),attachments:i?n?.map(a=>({...a})):void 0}])}async function Vr(e,t,n){Ai(e);const s=await ed(e,t,n?.attachments);return!s&&n?.previousDraft!=null&&(e.chatMessage=n.previousDraft),!s&&n?.previousAttachments&&(e.chatAttachments=n.previousAttachments),s&&zr(e,e.sessionKey),s&&n?.restoreDraft&&n.previousDraft?.trim()&&(e.chatMessage=n.previousDraft),s&&n?.restoreAttachments&&n.previousAttachments?.length&&(e.chatAttachments=n.previousAttachments),an(e),s&&!e.chatRunId&&Gr(e),s}async function Gr(e){if(!e.connected||qr(e))return;const[t,...n]=e.chatQueue;if(!t)return;e.chatQueue=n,await Vr(e,t.text,{attachments:t.attachments})||(e.chatQueue=[t,...e.chatQueue])}function ju(e,t){e.chatQueue=e.chatQueue.filter(n=>n.id!==t)}async function qu(e,t,n){if(!e.connected)return;const s=e.chatMessage,i=(t??e.chatMessage).trim(),a=e.chatAttachments??[],o=t==null?a:[],l=o.length>0;if(!(!i&&!l)){if(Hu(i)){await Wr(e);return}if(t==null&&(e.chatMessage="",e.chatAttachments=[]),qr(e)){Ku(e,i,o);return}await Vr(e,i,{previousDraft:t==null?s:void 0,restoreDraft:!!(t&&n?.restoreDraft),attachments:l?o:void 0,previousAttachments:t==null?a:void 0,restoreAttachments:!!(t&&n?.restoreDraft)})}}async function Qr(e){await Promise.all([en(e),Mt(e),ti(e)]),an(e)}const Wu=Gr;function Vu(e){const t=jr(e.sessionKey);return t?.agentId?t.agentId:e.hello?.snapshot?.sessionDefaults?.defaultAgentId?.trim()||"main"}function Gu(e,t){const n=ln(e),s=encodeURIComponent(t);return n?`${n}/avatar/${s}?meta=1`:`/avatar/${s}?meta=1`}async function ti(e){if(!e.connected){e.chatAvatarUrl=null;return}const t=Vu(e);if(!t){e.chatAvatarUrl=null;return}e.chatAvatarUrl=null;const n=Gu(e.basePath,t);try{const s=await fetch(n,{method:"GET"});if(!s.ok){e.chatAvatarUrl=null;return}const i=await s.json(),a=typeof i.avatarUrl=="string"?i.avatarUrl.trim():"";e.chatAvatarUrl=a||null}catch{e.chatAvatarUrl=null}}const Qu={trace:!0,debug:!0,info:!0,warn:!0,error:!0,fatal:!0},Yu={name:"",description:"",agentId:"",enabled:!0,scheduleKind:"every",scheduleAt:"",everyAmount:"30",everyUnit:"minutes",cronExpr:"0 7 * * *",cronTz:"",sessionTarget:"isolated",wakeMode:"next-heartbeat",payloadKind:"agentTurn",payloadText:"",deliveryMode:"announce",deliveryChannel:"last",deliveryTo:"",timeoutSeconds:"",postToMainPrefix:"Cron"},Yr={WEBCHAT_UI:"webchat-ui",CONTROL_UI:"clawdbot-control-ui",WEBCHAT:"webchat",CLI:"cli",GATEWAY_CLIENT:"gateway-client",MACOS_APP:"clawdbot-macos",IOS_APP:"clawdbot-ios",ANDROID_APP:"clawdbot-android",NODE_HOST:"node-host",TEST:"test",FINGERPRINT:"fingerprint",PROBE:"clawdbot-probe"},Ya=Yr,ni={WEBCHAT:"webchat",CLI:"cli",UI:"ui",BACKEND:"backend",NODE:"node",PROBE:"probe",TEST:"test"};new Set(Object.values(Yr));new Set(Object.values(ni));function Zu(e){const t=e.version??(e.nonce?"v2":"v1"),n=e.scopes.join(","),s=e.token??"",i=[t,e.deviceId,e.clientId,e.clientMode,e.role,n,String(e.signedAtMs),s];return t==="v2"&&i.push(e.nonce??""),i.join("|")}const Xu=4008;class Ju{constructor(t){this.opts=t,this.ws=null,this.pending=new Map,this.closed=!1,this.lastSeq=null,this.connectNonce=null,this.connectSent=!1,this.connectTimer=null,this.backoffMs=800}start(){this.closed=!1,this.connect()}stop(){this.closed=!0,this.ws?.close(),this.ws=null,this.flushPending(new Error("gateway client stopped"))}get connected(){return this.ws?.readyState===WebSocket.OPEN}connect(){this.closed||(this.ws=new WebSocket(this.opts.url),this.ws.onopen=()=>this.queueConnect(),this.ws.onmessage=t=>this.handleMessage(String(t.data??"")),this.ws.onclose=t=>{const n=String(t.reason??"");this.ws=null,this.flushPending(new Error(`gateway closed (${t.code}): ${n}`)),this.opts.onClose?.({code:t.code,reason:n}),this.scheduleReconnect()},this.ws.onerror=()=>{})}scheduleReconnect(){if(this.closed)return;const t=this.backoffMs;this.backoffMs=Math.min(this.backoffMs*1.7,15e3),window.setTimeout(()=>this.connect(),t)}flushPending(t){for(const[,n]of this.pending)n.reject(t);this.pending.clear()}async sendConnect(){if(this.connectSent)return;this.connectSent=!0,this.connectTimer!==null&&(window.clearTimeout(this.connectTimer),this.connectTimer=null);const t=typeof crypto<"u"&&!!crypto.subtle,n=["operator.admin","operator.approvals","operator.pairing"],s="operator";let i=null,a=!1,o=this.opts.token;if(t){i=await Di();const p=au({deviceId:i.deviceId,role:s})?.token;o=p??this.opts.token,a=!!(p&&this.opts.token)}const l=o||this.opts.password?{token:o,password:this.opts.password}:void 0;let c;if(t&&i){const p=Date.now(),g=this.connectNonce??void 0,h=Zu({deviceId:i.deviceId,clientId:this.opts.clientName??Ya.CONTROL_UI,clientMode:this.opts.mode??ni.WEBCHAT,role:s,scopes:n,signedAtMs:p,token:o??null,nonce:g}),f=await su(i.privateKey,h);c={id:i.deviceId,publicKey:i.publicKey,signature:f,signedAt:p,nonce:g}}const u={minProtocol:3,maxProtocol:3,client:{id:this.opts.clientName??Ya.CONTROL_UI,version:this.opts.clientVersion??"dev",platform:this.opts.platform??navigator.platform??"web",mode:this.opts.mode??ni.WEBCHAT,instanceId:this.opts.instanceId},role:s,scopes:n,device:c,caps:[],auth:l,userAgent:navigator.userAgent,locale:navigator.language};this.request("connect",u).then(p=>{p?.auth?.deviceToken&&i&&Pr({deviceId:i.deviceId,role:p.auth.role??s,token:p.auth.deviceToken,scopes:p.auth.scopes??[]}),this.backoffMs=800,this.opts.onHello?.(p)}).catch(()=>{a&&i&&Dr({deviceId:i.deviceId,role:s}),this.ws?.close(Xu,"connect failed")})}handleMessage(t){let n;try{n=JSON.parse(t)}catch{return}const s=n;if(s.type==="event"){const i=n;if(i.event==="connect.challenge"){const o=i.payload,l=o&&typeof o.nonce=="string"?o.nonce:null;l&&(this.connectNonce=l,this.sendConnect());return}const a=typeof i.seq=="number"?i.seq:null;a!==null&&(this.lastSeq!==null&&a>this.lastSeq+1&&this.opts.onGap?.({expected:this.lastSeq+1,received:a}),this.lastSeq=a);try{this.opts.onEvent?.(i)}catch(o){console.error("[gateway] event handler error:",o)}return}if(s.type==="res"){const i=n,a=this.pending.get(i.id);if(!a)return;this.pending.delete(i.id),i.ok?a.resolve(i.payload):a.reject(new Error(i.error?.message??"request failed"));return}}request(t,n){if(!this.ws||this.ws.readyState!==WebSocket.OPEN)return Promise.reject(new Error("gateway not connected"));const s=Si(),i={type:"req",id:s,method:t,params:n},a=new Promise((o,l)=>{this.pending.set(s,{resolve:c=>o(c),reject:l})});return this.ws.send(JSON.stringify(i)),a}queueConnect(){this.connectNonce=null,this.connectSent=!1,this.connectTimer!==null&&window.clearTimeout(this.connectTimer),this.connectTimer=window.setTimeout(()=>{this.sendConnect()},750)}}function si(e){return typeof e=="object"&&e!==null}function eg(e){if(!si(e))return null;const t=typeof e.id=="string"?e.id.trim():"",n=e.request;if(!t||!si(n))return null;const s=typeof n.command=="string"?n.command.trim():"";if(!s)return null;const i=typeof e.createdAtMs=="number"?e.createdAtMs:0,a=typeof e.expiresAtMs=="number"?e.expiresAtMs:0;return!i||!a?null:{id:t,request:{command:s,cwd:typeof n.cwd=="string"?n.cwd:null,host:typeof n.host=="string"?n.host:null,security:typeof n.security=="string"?n.security:null,ask:typeof n.ask=="string"?n.ask:null,agentId:typeof n.agentId=="string"?n.agentId:null,resolvedPath:typeof n.resolvedPath=="string"?n.resolvedPath:null,sessionKey:typeof n.sessionKey=="string"?n.sessionKey:null},createdAtMs:i,expiresAtMs:a}}function tg(e){if(!si(e))return null;const t=typeof e.id=="string"?e.id.trim():"";return t?{id:t,decision:typeof e.decision=="string"?e.decision:null,resolvedBy:typeof e.resolvedBy=="string"?e.resolvedBy:null,ts:typeof e.ts=="number"?e.ts:null}:null}function Zr(e){const t=Date.now();return e.filter(n=>n.expiresAtMs>t)}function ng(e,t){const n=Zr(e).filter(s=>s.id!==t.id);return n.push(t),n}function Za(e,t){return Zr(e).filter(n=>n.id!==t)}const sg=50,ig=200,ag="Assistant";function Xa(e,t){if(typeof e!="string")return;const n=e.trim();if(n)return n.length<=t?n:n.slice(0,t)}function ii(e){const t=Xa(e?.name,sg)??ag,n=Xa(e?.avatar??void 0,ig)??null;return{agentId:typeof e?.agentId=="string"&&e.agentId.trim()?e.agentId.trim():null,name:t,avatar:n}}function og(){return ii(typeof window>"u"?{}:{name:window.__CLAWDBOT_ASSISTANT_NAME__,avatar:window.__CLAWDBOT_ASSISTANT_AVATAR__})}async function Xr(e,t){if(!e.client||!e.connected)return;const n=e.sessionKey.trim(),s=n?{sessionKey:n}:{};try{const i=await e.client.request("agent.identity.get",s);if(!i)return;const a=ii(i);e.assistantName=a.name,e.assistantAvatar=a.avatar,e.assistantAgentId=a.agentId??null}catch{}}function Cs(e,t){const n=(e??"").trim(),s=t.mainSessionKey?.trim();if(!s)return n;if(!n)return s;const i=t.mainKey?.trim()||"main",a=t.defaultAgentId?.trim();return n==="main"||n===i||a&&(n===`agent:${a}:main`||n===`agent:${a}:${i}`)?s:n}function rg(e,t){if(!t?.mainSessionKey)return;const n=Cs(e.sessionKey,t),s=Cs(e.settings.sessionKey,t),i=Cs(e.settings.lastActiveSessionKey,t),a=n||s||e.sessionKey,o={...e.settings,sessionKey:s||a,lastActiveSessionKey:i||a},l=o.sessionKey!==e.settings.sessionKey||o.lastActiveSessionKey!==e.settings.lastActiveSessionKey;a!==e.sessionKey&&(e.sessionKey=a),l&&ht(e,o)}function Jr(e){e.lastError=null,e.hello=null,e.connected=!1,e.execApprovalQueue=[],e.execApprovalError=null,e.client?.stop(),e.client=new Ju({url:e.settings.gatewayUrl,token:e.settings.token.trim()?e.settings.token:void 0,password:e.password.trim()?e.password:void 0,clientName:"clawdbot-control-ui",mode:"webchat",onHello:t=>{e.connected=!0,e.lastError=null,e.hello=t,dg(e,t),Xr(e),Mi(e),Qn(e,{quiet:!0}),Ze(e,{quiet:!0}),Ki(e)},onClose:({code:t,reason:n})=>{e.connected=!1,t!==1012&&(e.lastError=`disconnected (${t}): ${n||"no reason"}`)},onEvent:t=>lg(e,t),onGap:({expected:t,received:n})=>{e.lastError=`event gap detected (expected seq ${t}, got ${n}); refresh recommended`}}),e.client.start()}function lg(e,t){try{cg(e,t)}catch(n){console.error("[gateway] handleGatewayEvent error:",t.event,n)}}function cg(e,t){if(e.eventLogBuffer=[{ts:Date.now(),event:t.event,payload:t.payload},...e.eventLogBuffer].slice(0,250),e.tab==="debug"&&(e.eventLog=e.eventLogBuffer),t.event==="agent"){if(e.onboarding)return;fd(e,t.payload);return}if(t.event==="chat"){const n=t.payload;n?.sessionKey&&zr(e,n.sessionKey);const s=nd(e,n);(s==="final"||s==="error"||s==="aborted")&&(Ai(e),Wu(e)),s==="final"&&en(e);return}if(t.event==="presence"){const n=t.payload;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence,e.presenceError=null,e.presenceStatus=null);return}if(t.event==="cron"&&e.tab==="cron"&&Nn(e),(t.event==="device.pair.requested"||t.event==="device.pair.resolved")&&Ze(e,{quiet:!0}),t.event==="exec.approval.requested"){const n=eg(t.payload);if(n){e.execApprovalQueue=ng(e.execApprovalQueue,n),e.execApprovalError=null;const s=Math.max(0,n.expiresAtMs-Date.now()+500);window.setTimeout(()=>{e.execApprovalQueue=Za(e.execApprovalQueue,n.id)},s)}return}if(t.event==="exec.approval.resolved"){const n=tg(t.payload);n&&(e.execApprovalQueue=Za(e.execApprovalQueue,n.id))}}function dg(e,t){const n=t.snapshot;n?.presence&&Array.isArray(n.presence)&&(e.presenceEntries=n.presence),n?.health&&(e.debugHealth=n.health),n?.sessionDefaults&&rg(e,n.sessionDefaults)}function ug(e){e.basePath=Pu(),Nu(e,!0),Du(e),Fu(e),window.addEventListener("popstate",e.popStateHandler),Mu(e),Jr(e),Ad(e),e.tab==="logs"&&Ti(e),e.tab==="debug"&&Ei(e)}function gg(e){bd(e)}function pg(e){window.removeEventListener("popstate",e.popStateHandler),Cd(e),_i(e),Li(e),Ou(e),e.topbarObserver?.disconnect(),e.topbarObserver=null}function fg(e,t){if(e.tab==="chat"&&(t.has("chatMessages")||t.has("chatToolMessages")||t.has("chatStream")||t.has("chatLoading")||t.has("tab"))){const n=t.has("tab"),s=t.has("chatLoading")&&t.get("chatLoading")===!0&&e.chatLoading===!1;an(e,n||s||!e.chatHasAutoScrolled)}e.tab==="logs"&&(t.has("logsEntries")||t.has("logsAutoFollow")||t.has("tab"))&&e.logsAutoFollow&&e.logsAtBottom&&fr(e,t.has("tab")||t.has("logsAutoFollow"))}const ji={CHILD:2},qi=e=>(...t)=>({_$litDirective$:e,values:t});let Wi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,s){this._$Ct=t,this._$AM=n,this._$Ci=s}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}};const{I:hg}=fc,Ja=e=>e,vg=e=>e.strings===void 0,eo=()=>document.createComment(""),Dt=(e,t,n)=>{const s=e._$AA.parentNode,i=t===void 0?e._$AB:t._$AA;if(n===void 0){const a=s.insertBefore(eo(),i),o=s.insertBefore(eo(),i);n=new hg(a,o,e,e.options)}else{const a=n._$AB.nextSibling,o=n._$AM,l=o!==e;if(l){let c;n._$AQ?.(e),n._$AM=e,n._$AP!==void 0&&(c=e._$AU)!==o._$AU&&n._$AP(c)}if(a!==i||l){let c=n._$AA;for(;c!==a;){const u=Ja(c).nextSibling;Ja(s).insertBefore(c,i),c=u}}}return n},nt=(e,t,n=e)=>(e._$AI(t,n),e),mg={},bg=(e,t=mg)=>e._$AH=t,yg=e=>e._$AH,Ts=e=>{e._$AR(),e._$AA.remove()};const to=(e,t,n)=>{const s=new Map;for(let i=t;i<=n;i++)s.set(e[i],i);return s},el=qi(class extends Wi{constructor(e){if(super(e),e.type!==ji.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let s;n===void 0?n=t:t!==void 0&&(s=t);const i=[],a=[];let o=0;for(const l of e)i[o]=s?s(l,o):o,a[o]=n(l,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,s]){const i=yg(e),{values:a,keys:o}=this.dt(t,n,s);if(!Array.isArray(i))return this.ut=o,a;const l=this.ut??=[],c=[];let u,p,g=0,h=i.length-1,f=0,d=a.length-1;for(;g<=h&&f<=d;)if(i[g]===null)g++;else if(i[h]===null)h--;else if(l[g]===o[f])c[f]=nt(i[g],a[f]),g++,f++;else if(l[h]===o[d])c[d]=nt(i[h],a[d]),h--,d--;else if(l[g]===o[d])c[d]=nt(i[g],a[d]),Dt(e,c[d+1],i[g]),g++,d--;else if(l[h]===o[f])c[f]=nt(i[h],a[f]),Dt(e,i[g],i[h]),h--,f++;else if(u===void 0&&(u=to(o,f,d),p=to(l,g,h)),u.has(l[g]))if(u.has(l[h])){const v=p.get(o[f]),$=v!==void 0?i[v]:null;if($===null){const x=Dt(e,i[g]);nt(x,a[f]),c[f]=x}else c[f]=nt($,a[f]),Dt(e,i[g],$),i[v]=null;f++}else Ts(i[h]),h--;else Ts(i[g]),g++;for(;f<=d;){const v=Dt(e,c[d+1]);nt(v,a[f]),c[f++]=v}for(;g<=h;){const v=i[g++];v!==null&&Ts(v)}return this.ut=o,bg(e,c),Qe}}),le={messageSquare:r`
  ...
  `}function Zg(e){const{agent:t,configForm:n,agentFilesList:s,agentIdentity:i,agentIdentityLoading:a,agentIdentityError:o,configLoading:l,configSaving:c,configDirty:u,onConfigReload:p,onConfigSave:g,onModelChange:h,onModelFallbacksChange:f}=e,d=ns(n,t.id),$=(s&&s.agentId===t.id?s.workspace:null)||d.entry?.workspace||d.defaults?.workspace||"default",x=d.entry?.model?Wt(d.entry?.model):Wt(d.defaults?.model),y=Wt(d.defaults?.model),C=ao(d.entry?.model)||(x!=="-"?io(x):null),A=ao(d.defaults?.model)||(y!=="-"?io(y):null),T=C??A??null,_=Hg(d.entry?.model),I=_?_.join(", "):"",q=i?.name?.trim()||t.identity?.name?.trim()||t.name?.trim()||d.entry?.name||"-",te=ts(t,i)||"-",F=Array.isArray(d.entry?.skills)?d.entry?.skills:null,U=F?.length??null,ce=a?"加载中…":o?"不可用":"",L=!!(e.defaultId&&t.id===e.defaultId);return r`
    <section class="card">
  ...
  `}function cp(e){const t=ns(e.configForm,e.agentId),n=t.entry?.tools??{},s=t.globalTools??{},i=n.profile??s.profile??"full",a=n.profile?"代理覆盖":s.profile?"全局默认":"默认",o=Array.isArray(n.allow)&&n.allow.length>0,l=Array.isArray(s.allow)&&s.allow.length>0,c=!!e.configForm&&!e.configLoading&&!e.configSaving&&!o,u=o?[]:Array.isArray(n.alsoAllow)?n.alsoAllow:[],p=o?[]:Array.isArray(n.deny)?n.deny:[],g=o?{allow:n.allow??[],deny:n.deny??[]}:Dg(i)??void 0,h=so.flatMap(x=>x.tools.map(y=>y.id)),f=x=>{const y=Vg(x,g),C=oo(x,u),A=oo(x,p);return{allowed:(y||C)&&!A,baseAllowed:y,denied:A}},d=h.filter(x=>f(x).allowed).length,v=(x,y)=>{const C=new Set(u.map(I=>Pe(I)).filter(I=>I.length>0)),A=new Set(p.map(I=>Pe(I)).filter(I=>I.length>0)),T=f(x).baseAllowed,_=Pe(x);y?(A.delete(_),T||C.add(_)):(C.delete(_),A.add(_)),e.onOverridesChange(e.agentId,[...C],[...A])},$=x=>{const y=new Set(u.map(A=>Pe(A)).filter(A=>A.length>0)),C=new Set(p.map(A=>Pe(A)).filter(A=>A.length>0));for(const A of h){const T=f(A).baseAllowed,_=Pe(A);x?(C.delete(_),T||y.add(_)):(y.delete(_),C.add(_))}e.onOverridesChange(e.agentId,[...y],[...C])};return r`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      <div class="agent-tools-presets" style="margin-top: 16px;">
        ...
        <div class="agent-tools-buttons">
          ${zg.map(x=>r`
              <button
                class="btn btn--sm ${i===x.id?"active":""}"
                ?disabled=${!c}
                @click=${()=>e.onProfileChange(e.agentId,x.id,!0)}
              >
                ${x.label}
              </button>
            `)}
      ...
      <div class="agent-tools-grid" style="margin-top: 20px;">
        ${so.map(x=>r`
            <div class="agent-tools-section">
              <div class="agent-tools-header">${x.label}</div>
              <div class="agent-tools-list">
                ${x.tools.map(y=>{const{allowed:C}=f(y.id);return r`
  ...
  `}function fp(e){if(!e&&e!==0)return"n/a";const t=Math.round(e/1e3);if(t<60)return`${t}s`;const n=Math.round(t/60);return n<60?`${n}m`:`${Math.round(n/60)}h`}function hp(e,t){const n=t.snapshot,s=n?.channels;if(!n||!s)return!1;const i=s[e],a=typeof i?.configured=="boolean"&&i.configured,o=typeof i?.running=="boolean"&&i.running,l=typeof i?.connected=="boolean"&&i.connected,u=(n.channelAccounts?.[e]??[]).some(p=>p.configured||p.running||p.connected);return a||o||l||u}function vp(e,t){return t?.[e]?.length??0}function ll(e,t){const n=vp(e,t);return n<2?m:r`<div class="account-count">账户 (${n})</div>`}function De(e){if(e)return Array.isArray(e.type)?e.type.filter(n=>n!=="null")[0]??e.type[0]:e.type}function cl(e){if(!e)return"";if(e.default!==void 0)return e.default;switch(De(e)){case"object":return{};case"array":return[];case"boolean":return!1;case"number":case"integer":return 0;case"string":return"";default:return""}}function ss(e){return e.filter(t=>typeof t=="string").join(".")}function Se(e,t){const n=ss(e),s=t[n];if(s)return s;const i=n.split(".");for(const[a,o]of Object.entries(t)){if(!a.includes("*"))continue;const l=a.split(".");if(l.length!==i.length)continue;let c=!0;for(let u=0;u<i.length;u+=1)if(l[u]!=="*"&&l[u]!==i[u]){c=!1;break}if(c)return o}}function qe(e){return e.replace(/_/g," ").replace(/([a-z0-9])([A-Z])/g,"$1 $2").replace(/\s+/g," ").replace(/^./,t=>t.toUpperCase())}function mp(e){const t=ss(e).toLowerCase();return t.includes("token")||t.includes("password")||t.includes("secret")||t.includes("apikey")||t.endsWith("key")}const bp=new Set(["title","description","default","nullable"]);function yp(e){return Object.keys(e??{}).filter(n=>!bp.has(n)).length===0}function xp(e){if(e===void 0)return"";try{return JSON.stringify(e,null,2)??""}catch{return""}}const sn={chevronDown:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`,plus:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>`,minus:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line></svg>`,trash:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>`,edit:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>`};function je(e){const{schema:t,value:n,path:s,hints:i,unsupported:a,disabled:o,onPatch:l}=e,c=e.showLabel??!0,u=De(t),p=Se(s,i),g=p?.label??t.title??qe(String(s.at(-1))),h=p?.help??t.description,f=ss(s);if(a.has(f))return r`<div class="cfg-field cfg-field--error">
      ...
      `}if(y&&x.length>5)return lo({...e,options:x,value:n??t.default});const C=new Set(v.map(T=>De(T)).filter(Boolean)),A=new Set([...C].map(T=>T==="integer"?"number":T));if([...A].every(T=>["string","number","boolean"].includes(T))){const T=A.has("string"),_=A.has("number");if(A.has("boolean")&&A.size===1)return je({...e,schema:{...t,type:"boolean",anyOf:void 0,oneOf:void 0}});if(T||_)return ro({...e,inputType:_&&!T?"number":"text"})}}if(t.enum){const d=t.enum;if(d.length<=5){const v=n??t.default;return r`
        <div class="cfg-field">
          ${c?r`<label class="cfg-field__label">${g}</label>`:m}
          ${h?r`<div class="cfg-field__help">${h}</div>`:m}
          <div class="cfg-segmented">
    ...
    <div class="cfg-field">
      ...
      <div class="cfg-input-wrap">
        <input
          ...
          ?disabled=${a}
          @input=${v=>{const $=v.target.value;if(l==="number"){if($.trim()===""){o(s,void 0);return}const x=Number($);o(s,Number.isNaN(x)?$:x);return}o(s,$)}}
        />
        ${t.default!==void 0?r`
          <button
            type="button"
  ...
  `}function lo(e){const{schema:t,value:n,path:s,hints:i,disabled:a,options:o,onPatch:l}=e,c=e.showLabel??!0,u=Se(s,i),p=u?.label??t.title??qe(String(s.at(-1))),g=u?.help??t.description,h=n??t.default,f=o.findIndex(v=>v===h||String(v)===String(h)),d="__unset__";return r`
    <div class="cfg-field">
      ...
      <select
        ...
        @change=${v=>{const $=v.target.value;l(s,$===d?void 0:o[Number($)])}}
      >
              ...
              <div class="cfg-map__item">
                <div class="cfg-map__item-key">
                  <input
                    ...
                    .value=${g}
                    ?disabled=${o}
                    @change=${v=>{const $=v.target.value.trim();if(!$||$===g)return;const x={...n??{}};$ in x||(x[$]=x[g],delete x[g],c(s,x))}}
                  />
                </div>
                <div class="cfg-map__item-value">
                  ${u?r`
                        <textarea
                          ...
                          .value=${d}
                          ?disabled=${o}
                          @change=${v=>{const $=v.target,x=$.value.trim();if(!x){c(f,void 0);return}try{c(f,JSON.parse(x))}catch{$.value=d}}}
                        ></textarea>
  ...
  `}const uo={env:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>`,update:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>`,agents:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2z"></path><circle cx="8" cy="14" r="1"></circle><circle cx="16" cy="14" r="1"></circle></svg>`,auth:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>`,channels:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>`,messages:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>`,commands:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="4 17 10 11 4 5"></polyline><line x1="12" y1="19" x2="20" y2="19"></line></svg>`,hooks:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>`,skills:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>`,tools:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg>`,gateway:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>`,wizard:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M15 4V2"></path><path d="M15 16v-2"></path><path d="M8 9h2"></path><path d="M20 9h2"></path><path d="M17.8 11.8 19 13"></path><path d="M15 9h0"></path><path d="M17.8 6.2 19 5"></path><path d="m3 21 9-9"></path><path d="M12.2 6.2 11 5"></path></svg>`,meta:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg>`,logging:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`,browser:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="4"></circle><line x1="21.17" y1="8" x2="12" y2="8"></line><line x1="3.95" y1="6.06" x2="8.54" y2="14"></line><line x1="10.88" y1="21.94" x2="15.46" y2="14"></line></svg>`,ui:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>`,models:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>`,bindings:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"></rect><rect x="2" y="14" width="20" height="8" rx="2" ry="2"></rect><line x1="6" y1="6" x2="6.01" y2="6"></line><line x1="6" y1="18" x2="6.01" y2="18"></line></svg>`,broadcast:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4.9 19.1C1 15.2 1 8.8 4.9 4.9"></path><path d="M7.8 16.2c-2.3-2.3-2.3-6.1 0-8.5"></path><circle cx="12" cy="12" r="2"></circle><path d="M16.2 7.8c2.3 2.3 2.3 6.1 0 8.5"></path><path d="M19.1 4.9C23 8.8 23 15.1 19.1 19"></path></svg>`,audio:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>`,session:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>`,cron:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`,web:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>`,discovery:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>`,canvasHost:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg>`,talk:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg>`,plugins:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2v6"></path><path d="m4.93 10.93 4.24 4.24"></path><path d="M2 12h6"></path><path d="m4.93 13.07 4.24-4.24"></path><path d="M12 22v-6"></path><path d="m19.07 13.07-4.24-4.24"></path><path d="M22 12h-6"></path><path d="m19.07 10.93-4.24 4.24"></path></svg>`,default:r`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg>`},Gi={env:{label:"环境变量",description:"传递给网关进程的环境变量"},update:{label:"更新",description:"自动更新设置和发布渠道"},agents:{label:"代理",description:"代理配置、模型和身份"},auth:{label:"身份验证",description:"API密钥和身份验证配置文件"},channels:{label:"通道",description:"消息通道（Telegram、Discord、Slack等）"},messages:{label:"消息",description:"消息处理和路由设置"},commands:{label:"命令",description:"自定义斜杠命令"},hooks:{label:"钩子",description:"Webhooks和事件钩子"},skills:{label:"技能",description:"技能包和能力"},tools:{label:"工具",description:"工具配置（浏览器、搜索等）"},gateway:{label:"网关",description:"网关服务器设置（端口、身份验证、绑定）"},wizard:{label:"设置向导",description:"设置向导状态和历史记录"},diagnostics:{label:"诊断",description:"诊断设置"},meta:{label:"元数据",description:"网关元数据和版本信息"},logging:{label:"日志",description:"日志级别和输出配置"},browser:{label:"浏览器",description:"浏览器自动化设置"},ui:{label:"用户界面",description:"用户界面偏好设置"},models:{label:"模型",description:"AI模型配置和提供商"},bindings:{label:"绑定",description:"键绑定和快捷键"},broadcast:{label:"广播",description:"广播和通知设置"},audio:{label:"音频",description:"音频输入/输出设置"},session:{label:"会话",description:"会话管理和持久化"},cron:{label:"定时任务",description:"计划任务和自动化"},web:{label:"Web",description:"Web服务器和API设置"},discovery:{label:"发现",description:"服务发现和网络"},canvasHost:{label:"Canvas主机",description:"Canvas渲染和显示"},talk:{label:"语音",description:"语音和语音设置"},plugins:{label:"插件",description:"插件管理和扩展"}};function go(e){return uo[e]??uo.default}function Sp(e,t,n){if(!n)return!0;const s=n.toLowerCase(),i=Gi[e];return e.toLowerCase().includes(s)||i&&(i.label.toLowerCase().includes(s)||i.description.toLowerCase().includes(s))?!0:Kt(t,s)}function Kt(e,t){if(e.title?.toLowerCase().includes(t)||e.description?.toLowerCase().includes(t)||e.enum?.some(s=>String(s).toLowerCase().includes(t)))return!0;if(e.properties){for(const[s,i]of Object.entries(e.properties))if(s.toLowerCase().includes(t)||Kt(i,t))return!0}if(e.items){const s=Array.isArray(e.items)?e.items:[e.items];for(const i of s)if(i&&Kt(i,t))return!0}if(e.additionalProperties&&typeof e.additionalProperties=="object"&&Kt(e.additionalProperties,t))return!0;const n=e.anyOf??e.oneOf??e.allOf;if(n){for(const s of n)if(s&&Kt(s,t))return!0}return!1}function Ap(e){if(!e.schema)return r`<div class="muted">模式不可用。</div>`;const t=e.schema,n=e.value??{};if(De(t)!=="object"||!t.properties)return r`<div class="callout danger">不支持的模式。使用原始模式。</div>`;const s=new Set(e.unsupportedPaths??[]),i=t.properties,a=e.searchQuery??"",o=e.activeSection,l=e.activeSubsection??null,u=Object.entries(i).sort((g,h)=>{const f=Se([g[0]],e.uiHints)?.order??50,d=Se([h[0]],e.uiHints)?.order??50;return f!==d?f-d:g[0].localeCompare(h[0])}).filter(([g,h])=>!(o&&g!==o||a&&!Sp(g,h,a)));let p=null;if(o&&l&&u.length===1){const g=u[0]?.[1];g&&De(g)==="object"&&g.properties&&g.properties[l]&&(p={sectionKey:o,subsectionKey:l,schema:g.properties[l]})}return u.length===0?r`
    ...
    <div class="config-form config-form--modern">
      ${p?(()=>{const{sectionKey:g,subsectionKey:h,schema:f}=p,d=Se([g,h],e.uiHints),v=d?.label??f.title??qe(h),$=d?.help??f.description??"",x=n[g],y=x&&typeof x=="object"?x[h]:void 0,C=`config-section-${g}-${h}`;return r`
              <section class="config-section-card" id=${C}>
                <div class="config-section-card__header">
                  ...
                  <div class="config-section-card__titles">
                    ...
                    ${$?r`<p class="config-section-card__desc">${$}</p>`:m}
                  </div>
                </div>
  ...
  `}function po(e){return e?e.length<=20?e:`${e.slice(0,8)}...${e.slice(-8)}`:"无"}function Np(e){const{props:t,nostr:n,nostrAccounts:s,accountCountLabel:i,profileFormState:a,profileFormCallbacks:o,onEditProfile:l}=e,c=s[0],u=n?.configured??c?.configured??!1,p=n?.running??c?.running??!1,g=n?.publicKey??c?.publicKey,h=n?.lastStartAt??c?.lastStartAt??null,f=n?.lastError??c?.lastError??null,d=s.length>1,v=a!=null,$=y=>{const C=y.publicKey,A=y.profile,T=A?.displayName??A?.name??y.name??y.accountId;return r`
    ...
    `},x=()=>{if(v&&o)return _c({state:a,callbacks:o,accountId:s[0]?.accountId??"default"});const y=c?.profile??n?.profile,{name:C,displayName:A,about:T,picture:_,nip05:I}=y??{},q=C||A||T||_||I;return r`
...
`,e=e.substring(h.length+1),c=!0),!c){let v=this.rules.other.nextBulletRegex(d),$=this.rules.other.hrRegex(d),x=this.rules.other.fencesBeginRegex(d),y=this.rules.other.headingBeginRegex(d),C=this.rules.other.htmlBeginRegex(d);for(;e;){let A=e.split(`
`,1)[0],T;if(h=A,this.options.pedantic?(h=h.replace(this.rules.other.listReplaceNesting,"  "),T=h):T=h.replace(this.rules.other.tabCharGlobal,"    "),x.test(h)||y.test(h)||C.test(h)||v.test(h)||$.test(h))break;if(T.search(this.rules.other.nonSpaceChar)>=d||!h.trim())p+=`
`+T.slice(d);else{if(f||g.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||x.test(g)||y.test(g)||$.test(g))break;p+=`
`+h}!f&&!h.trim()&&(f=!0),u+=A+`
...
`:""}*No output — tool completed successfully.*`;t(g)}:void 0,l=i&&(e.text?.length??0)<=Nh,c=i&&!l,u=i&&l,p=!i;return r`
  ...
  `}function Gh(e,t,n,s){const i=new Date(t).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}),a=s?.name??"助手";return r`
    <div class="chat-group assistant">
      ${aa("assistant",s)}
      <div class="chat-group-messages">
        ${Fl({role:"assistant",content:[{type:"text",text:e}],timestamp:t},{isStreaming:!0,showReasoning:!1},n)}
  ...
  `}function Qh(e,t){const n=ia(e.role),s=t.assistantName??"助手",i=n==="user"?"你":n==="assistant"?s:n,a=n==="user"?"user":n==="assistant"?"assistant":"other",o=new Date(e.timestamp).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});return r`
    <div class="chat-group ${a}">
      ...
      <div class="chat-group-messages">
        ${e.messages.map((l,c)=>Fl(l.message,{isStreaming:e.isStreaming&&c===e.messages.length-1,showReasoning:t.showReasoning},t.onOpenSidebar))}
        <div class="chat-group-footer">
      ...
      <div class="list-item">
        ...
        <div class="list-meta">
          <label class="field">
            ...
            <select
              ?disabled=${e.disabled}
              @change=${d=>{const $=d.target.value;!t&&$==="__default__"?e.onRemove([...i,"security"]):e.onPatch([...i,"security"],$)}}
            >
      ...
      <div class="list-item">
        ...
        <div class="list-meta">
          <label class="field">
            ...
            <select
              ?disabled=${e.disabled}
              @change=${d=>{const $=d.target.value;!t&&$==="__default__"?e.onRemove([...i,"ask"]):e.onPatch([...i,"ask"],$)}}
            >
      ...
      <div class="list-item">
        ...
        <div class="list-meta">
          <label class="field">
            ...
            <select
              ?disabled=${e.disabled}
              @change=${d=>{const $=d.target.value;!t&&$==="__default__"?e.onRemove([...i,"askFallback"]):e.onPatch([...i,"askFallback"],$)}}
            >
    ...
    <div class="table-row">
      ...
      <div>
        <input
          ...
          ?disabled=${i}
          placeholder="（可选）"
          @change=${v=>{const $=v.target.value.trim();n(e.key,{label:$||null})}}
        />
      </div>
      <div>${e.kind}</div>
      <div>${a}</div>
      ...
      <div>
        <select
          .value=${c}
          ?disabled=${i}
          @change=${v=>{const $=v.target.value;n(e.key,{thinkingLevel:rm($,l)})}}
        >
      ...
      <div>
        <select
          .value=${p}
          ?disabled=${i}
          @change=${v=>{const $=v.target.value;n(e.key,{verboseLevel:$||null})}}
        >
      ...
      <div>
        <select
          .value=${g}
          ?disabled=${i}
          @change=${v=>{const $=v.target.value;n(e.key,{reasoningLevel:$||null})}}
        >
...
`,$m=4;function it(e){return Math.round(e/$m)}function N(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e)}function wm(e){const t=new Date;return t.setHours(e,0,0,0),t.toLocaleTimeString(void 0,{hour:"numeric"})}function km(e,t){const n=Array.from({length:24},()=>0),s=Array.from({length:24},()=>0);for(const i of e){const a=i.usage;if(!a?.messageCounts||a.messageCounts.total===0)continue;const o=a.firstActivity??i.updatedAt,l=a.lastActivity??i.updatedAt;if(!o||!l)continue;const c=Math.min(o,l),u=Math.max(o,l),g=Math.max(u-c,1)/6e4;let h=c;for(;h<u;){const f=new Date(h),d=ra(f,t),v=la(f,t),$=Math.min(v.getTime(),u),y=Math.max(($-h)/6e4,0)/g;n[d]+=a.messageCounts.errors*y,s[d]+=a.messageCounts.total*y,h=$+1}}return s.map((i,a)=>{const o=n[a],l=i>0?o/i:0;return{hour:a,rate:l,errors:o,msgs:i}}).filter(i=>i.msgs>0&&i.errors>0).toSorted((i,a)=>a.rate-i.rate).slice(0,5).map(i=>({label:wm(i.hour),value:`${(i.rate*100).toFixed(2)}%`,sub:`${Math.round(i.errors)} 个错误 · ${Math.round(i.msgs)} 条消息`}))}const Sm=["周日","周一","周二","周三","周四","周五","周六"];function ra(e,t){return t==="utc"?e.getUTCHours():e.getHours()}function Am(e,t){return t==="utc"?e.getUTCDay():e.getDay()}function la(e,t){const n=new Date(e);return t==="utc"?n.setUTCMinutes(59,59,999):n.setMinutes(59,59,999),n}function Cm(e,t){const n=Array.from({length:24},()=>0),s=Array.from({length:7},()=>0);let i=0,a=!1;for(const l of e){const c=l.usage;if(!c||!c.totalTokens||c.totalTokens<=0)continue;i+=c.totalTokens;const u=c.firstActivity??l.updatedAt,p=c.lastActivity??l.updatedAt;if(!u||!p)continue;a=!0;const g=Math.min(u,p),h=Math.max(u,p),d=Math.max(h-g,1)/6e4;let v=g;for(;v<h;){const $=new Date(v),x=ra($,t),y=Am($,t),C=la($,t),A=Math.min(C.getTime(),h),_=Math.max((A-v)/6e4,0)/d;n[x]+=c.totalTokens*_,s[y]+=c.totalTokens*_,v=A+1}}const o=Sm.map((l,c)=>({label:l,tokens:s[c]}));return{hasData:a,totalTokens:i,hourTotals:n,weekdayTotals:o}}function Tm(e,t,n,s){const i=Cm(e,t);if(!i.hasData)return r`
...
`)},Dm=(e,t,n)=>{const s=e.trim();if(!s)return[];const i=s.length?s.split(/\s+/):[],a=i.length?i[i.length-1]:"",[o,l]=a.includes(":")?[a.slice(0,a.indexOf(":")),a.slice(a.indexOf(":")+1)]:["",""],c=o.toLowerCase(),u=l.toLowerCase(),p=y=>{const C=new Set;for(const A of y)A&&C.add(A);return Array.from(C)},g=p(t.map(y=>y.agentId)).slice(0,6),h=p(t.map(y=>y.channel)).slice(0,6),f=p([...t.map(y=>y.modelProvider),...t.map(y=>y.providerOverride),...n?.byProvider.map(y=>y.provider)??[]]).slice(0,6),d=p([...t.map(y=>y.model),...n?.byModel.map(y=>y.model)??[]]).slice(0,6),v=p(n?.tools.tools.map(y=>y.name)??[]).slice(0,6);if(!c)return[{label:"agent:",value:"agent:"},{label:"channel:",value:"channel:"},{label:"provider:",value:"provider:"},{label:"model:",value:"model:"},{label:"tool:",value:"tool:"},{label:"has:errors",value:"has:errors"},{label:"has:tools",value:"has:tools"},{label:"minTokens:",value:"minTokens:"},{label:"maxCost:",value:"maxCost:"}];const $=[],x=(y,C)=>{for(const A of C)(!u||A.toLowerCase().includes(u))&&$.push({label:`${y}:${A}`,value:`${y}:${A}`})};switch(c){case"agent":x("agent",g);break;case"channel":x("channel",h);break;case"provider":x("provider",f);break;case"model":x("model",d);break;case"tool":x("tool",v);break;case"has":["errors","tools","context","usage","model","provider"].forEach(y=>{(!u||y.includes(u))&&$.push({label:`has:${y}`,value:`has:${y}`})});break}return $},Fm=(e,t)=>{const n=e.trim();if(!n)return`${t} `;const s=n.split(/\s+/);return s[s.length-1]=t,`${s.join(" ")} `},rt=e=>e.trim().toLowerCase(),Om=(e,t)=>{const n=e.trim();if(!n)return`${t} `;const s=n.split(/\s+/),i=s[s.length-1]??"",a=t.includes(":")?t.split(":")[0]:null,o=i.includes(":")?i.split(":")[0]:null;return i.endsWith(":")&&a&&o===a?(s[s.length-1]=t,`${s.join(" ")} `):s.includes(t)?`${s.join(" ")} `:`${s.join(" ")} ${t} `},Wo=(e,t)=>{const s=e.trim().split(/\s+/).filter(Boolean).filter(i=>i!==t);return s.length?`${s.join(" ")} `:""},Vo=(e,t,n)=>{const s=rt(t),a=[...oa(e).filter(o=>rt(o.key??"")!==s).map(o=>o.raw),...n.map(o=>`${t}:${o}`)];return a.length?`${a.join(" ")} `:""};function ge(e,t){return t===0?0:e/t*100}function Nm(e){const t=e.totalCost||0;return{input:{tokens:e.input,cost:e.inputCost||0,pct:ge(e.inputCost||0,t)},output:{tokens:e.output,cost:e.outputCost||0,pct:ge(e.outputCost||0,t)},cacheRead:{tokens:e.cacheRead,cost:e.cacheReadCost||0,pct:ge(e.cacheReadCost||0,t)},cacheWrite:{tokens:e.cacheWrite,cost:e.cacheWriteCost||0,pct:ge(e.cacheWriteCost||0,t)},totalCost:t}}function Bm(e,t,n,s,i,a,o,l){if(!(e.length>0||t.length>0||n.length>0))return m;const u=n.length===1?s.find(d=>d.key===n[0]):null,p=u?(u.label||u.key).slice(0,20)+((u.label||u.key).length>20?"…":""):n.length===1?n[0].slice(0,8)+"…":`${n.length} sessions`,g=u?u.label||u.key:n.length===1?n[0]:n.join(", "),h=e.length===1?e[0]:`${e.length} days`,f=t.length===1?`${t[0]}:00`:`${t.length} hours`;return r`
        ...
        <div class="daily-chart-bars" style="--bar-max-width: ${u}px">
          ${e.map((g,h)=>{const d=l[h]/c*100,v=t.includes(g.date),$=Bl(g.date),x=e.length>20?String(parseInt(g.date.slice(8),10)):$,y=e.length>20?"font-size: 8px":"",C=s==="by-type"?o?[{value:g.output,class:"output"},{value:g.input,class:"input"},{value:g.cacheWrite,class:"cache-write"},{value:g.cacheRead,class:"cache-read"}]:[{value:g.outputCost??0,class:"output"},{value:g.inputCost??0,class:"input"},{value:g.cacheWriteCost??0,class:"cache-write"},{value:g.cacheReadCost??0,class:"cache-read"}]:[],A=s==="by-type"?o?[`输出 ${N(g.output)}`,`输入 ${N(g.input)}`,`缓存写入 ${N(g.cacheWrite)}`,`缓存读取 ${N(g.cacheRead)}`]:[`输出 ${G(g.outputCost??0)}`,`输入 ${G(g.inputCost??0)}`,`缓存写入 ${G(g.cacheWriteCost??0)}`,`缓存读取 ${G(g.cacheReadCost??0)}`]:[],T=o?N(g.totalTokens):G(g.totalCost);return r`
              ...
              >
                ...
                <div class="daily-bar-label" style="${y}">${x}</div>
  ...
  `}function Hm(e,t,n,s,i,a,o){if(!e)return m;const l=t.messages.total?Math.round(e.totalTokens/t.messages.total):0,c=t.messages.total?e.totalCost/t.messages.total:0,u=e.input+e.cacheRead,p=u>0?e.cacheRead/u:0,g=u>0?`${(p*100).toFixed(1)}%`:"—",h=n.errorRate*100,f=n.throughputTokensPerMin!==void 0?`${N(Math.round(n.throughputTokensPerMin))} tok/min`:"—",d=n.throughputCostPerMin!==void 0?`${G(n.throughputCostPerMin,4)} / min`:"—",v=n.durationCount>0?_m(n.avgDurationMs):"—",$="缓存命中率 = 缓存读取 / (输入 + 缓存读取)。越高越好。",x="错误率 = 错误数 / 消息总数。越低越好。",y="吞吐量显示活动时间内每分钟的 Token 数。越高越好。",C="此范围内每条消息的平均 Token 数。",A=s?"当供应商报告费用时的平均每条消息费用。此范围内部分或所有会话缺少费用数据。":"当供应商报告费用时的平均每条消息费用。",T=t.daily.filter(F=>F.messages>0&&F.errors>0).map(F=>{const U=F.errors/F.messages;return{label:Bl(F.date),value:`${(U*100).toFixed(2)}%`,sub:`${F.errors} 个错误 · ${F.messages} 条消息 · ${N(F.tokens)}`,rate:U}}).toSorted((F,U)=>U.rate-F.rate).slice(0,5).map(({rate:F,...U})=>U),_=t.byModel.slice(0,5).map(F=>({label:F.model??"unknown",value:G(F.totals.totalCost),sub:`${N(F.totals.totalTokens)} · ${F.count} 条消息`})),I=t.byProvider.slice(0,5).map(F=>({label:F.provider??"unknown",value:G(F.totals.totalCost),sub:`${N(F.totals.totalTokens)} · ${F.count} 条消息`})),q=t.tools.tools.slice(0,6).map(F=>({label:F.name,value:`${F.count}`,sub:"次调用"})),K=t.byAgent.slice(0,5).map(F=>({label:F.agentId,value:G(F.totals.totalCost),sub:N(F.totals.totalTokens)})),te=t.byChannel.slice(0,5).map(F=>({label:F.channel,value:G(F.totals.totalCost),sub:N(F.totals.totalTokens)}));return r`
    ...
    <div class="card sessions-card">
      ...
      ${l==="recent"?ce.length===0?r`
              ...
              `:r`
                <div class="session-bars" style="max-height: 220px; margin-top: 6px;">
                  ${ce.map(L=>{const B=C(L),ie=K.has(L.key),ae=$(L),X=y(L);return r`
                      <div
                      ...
                      >
                        ...
                        <div class="session-bar-actions">
                          <button
                            ...
                            title="复制会话名称"
                            @click=${ne=>{ne.stopPropagation(),x(L)}}
                          >
                            复制
                          </button>
              ...
              `:r`
                <div class="session-bars">
                  ${T.slice(0,50).map(L=>{const B=C(L),ie=t.includes(L.key),ae=$(L),X=y(L);return r`
                      <div
                        class="session-bar-row ${ie?"selected":""}"
                        @click=${ne=>c(L.key,ne.shiftKey)}
                        title="${L.key}"
      ...
      ${F>1?r`
              <div style="margin-top: 10px;">
                <div class="sessions-card-count">已选择 (${F})</div>
                <div class="session-bars" style="max-height: 160px; margin-top: 6px;">
                  ${te.map(L=>{const B=C(L),ie=$(L),ae=y(L);return r`
                      <div
  ...
  `}function Wm(e,t,n,s,i,a,o,l,c,u,p,g,h,f,d,v,$,x,y,C,A,T,_){const I=e.label||e.key,q=I.length>50?I.slice(0,50)+"…":I,K=e.usage;return r`
  ...
  `}function Vm(e,t,n,s,i,a,o,l,c){if(t)return r`
    ...
    `;let p=0,g=0,h=0,f=0,d=0,v=0;u=u.map(U=>(p+=U.totalTokens,g+=U.cost,h+=U.output,f+=U.input,d+=U.cacheRead,v+=U.cacheWrite,{...U,cumulativeTokens:p,cumulativeCost:g}));const $=400,x=80,y={top:16,right:10,bottom:20,left:40},C=$-y.left-y.right,A=x-y.top-y.bottom,T=n==="cumulative",_=n==="per-turn"&&i==="by-type",I=h+f+d+v,q=u.map(U=>T?U.cumulativeTokens:_?U.input+U.output+U.cacheRead+U.cacheWrite:U.totalTokens),K=Math.max(...q,1),te=Math.max(2,Math.min(8,C/u.length*.7)),F=Math.max(1,(C-te*u.length)/(u.length-1||1));return r`
    <div class="session-timeseries-compact">
      ...
      <svg viewBox="0 0 ${$} ${x+15}" class="timeseries-svg" style="width: 100%; height: auto;">
        <!-- Y axis -->
        ...
        `:m}
        <!-- Bars -->
        ${u.map((U,ce)=>{const L=q[ce],B=y.left+ce*(te+F),ie=L/K*A,ae=y.top+A-ie,ne=[new Date(U.timestamp).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),`${N(L)} tokens`];_&&(ne.push(`Output ${N(U.output)}`),ne.push(`Input ${N(U.input)}`),ne.push(`Cache write ${N(U.cacheWrite)}`),ne.push(`Cache read ${N(U.cacheRead)}`));const M=ne.join(" · ");if(!_)return mn`<rect x="${B}" y="${ae}" width="${te}" height="${ie}" class="ts-bar" rx="1" style="cursor: pointer;"><title>${M}</title></rect>`;const R=[{value:U.output,class:"output"},{value:U.input,class:"input"},{value:U.cacheWrite,class:"cache-write"},{value:U.cacheRead,class:"cache-read"}];let P=y.top+A;return mn`
    ...
    <div class="context-details-panel">
      ...
      <div class="context-breakdown-grid">
        ...
        ${g.length>0?(()=>{const C=g.length-$.length;return r`
                ...
                `})():m}
        ${h.length>0?(()=>{const C=h.length-x.length;return r`
                  <div class="context-breakdown-card">
  ...
  `}function Qm(e,t,n,s,i,a,o,l,c,u){if(t)return r`
    ...
    `;const p=i.query.trim().toLowerCase(),g=e.map(x=>{const y=ym(x.content),C=y.cleanContent||x.content;return{log:x,toolInfo:y,cleanContent:C}}),h=Array.from(new Set(g.flatMap(x=>x.toolInfo.tools.map(([y])=>y)))).toSorted((x,y)=>x.localeCompare(y)),f=g.filter(x=>!(i.roles.length>0&&!i.roles.includes(x.log.role)||i.hasTools&&x.toolInfo.tools.length===0||i.tools.length>0&&!x.toolInfo.tools.some(([C])=>i.tools.includes(C))||p&&!x.cleanContent.toLowerCase().includes(p))),d=i.roles.length>0||i.tools.length>0||i.hasTools||p?`${f.length} of ${e.length}`:`${e.length}`,v=new Set(i.roles),$=new Set(i.tools);return r`
    <div class="session-logs-compact">
      ...
      <div class="usage-filters-inline" style="margin: 10px 12px;">
        <select
          multiple
          size="4"
          @change=${x=>a(Array.from(x.target.selectedOptions).map(y=>y.value))}
        >
        ...
        <select
          multiple
          size="4"
          @change=${x=>o(Array.from(x.target.selectedOptions).map(y=>y.value))}
        >
          ${h.map(x=>r`<option value=${x} ?selected=${$.has(x)}>${x}</option>`)}
        </select>
        <label class="usage-filters-inline" style="gap: 6px;">
          <input
            type="checkbox"
            .checked=${i.hasTools}
            @change=${x=>l(x.target.checked)}
          />
          Has tools
        </label>
        <input
      ...
      <div class="session-logs-list">
        ${f.map(x=>{const{log:y,toolInfo:C,cleanContent:A}=x,T=y.role==="user"?"user":"assistant",_=y.role==="user"?"You":y.role==="assistant"?"Assistant":"Tool";return r`
  ...
  `}function Ym(e){if(e.loading&&!e.totals)return r`
            ...
            ${P.map(J=>{const pe=xe.has(rt(J));return r`
                <label class="usage-filter-option">
                  <input
                    type="checkbox"
                    .checked=${pe}
                    @change=${Fe=>{const Oe=Fe.target,Xe=`${M}:${J}`;e.onQueryDraftChange(Oe.checked?Om(e.queryDraft,Xe):Wo(e.queryDraft,Xe))}}
                  />
                  <span>${J}</span>
                </label>
              `})}
          ...
          >
            ...
            <div class="usage-export-popover">
              <div class="usage-export-list">
                ...
                <button
                  class="usage-export-item"
                  @click=${()=>Us(`openclaw-usage-${ne}.json`,JSON.stringify({totals:I,sessions:u,daily:U,aggregates:F},null,2),"application/json")}
    ...
    ${Hm(I,F,ce,B,km(te,e.timeZone),q,K)}
  ...
  `}let Hs=null;const Qo=e=>{Hs&&clearTimeout(Hs),Hs=window.setTimeout(()=>{zi(e)},400)},Zm=/^data:/i,Xm=/^https?:\/\//i;function Jm(e){const t=e.agentsList?.agents??[],s=jr(e.sessionKey)?.agentId??e.agentsList?.defaultId??"main",a=t.find(l=>l.id===s)?.identity,o=a?.avatarUrl??a?.avatar;if(o)return Zm.test(o)||Xm.test(o)?o:a?.avatarUrl}function eb(e){const t=e.presenceEntries.length,n=e.sessionsResult?.count??null,s=e.cronStatus?.nextWakeAtMs??null,i=e.connected?null:"已断开与网关的连接。",a=e.tab==="chat",o=a&&(e.settings.chatFocusMode||e.onboarding),l=e.onboarding?!1:e.settings.chatShowThinking,c=Jm(e),u=e.chatAvatarUrl??c??null,p=ln(e.basePath),g=p?`${p}/favicon.svg`:"/favicon.svg",h=e.configForm??e.configSnapshot?.config,f=e.agentsSelectedId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id??null;return r`
    <div class="shell ${a?"shell--chat":""} ${o?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ${wu.map(d=>{const v=e.settings.navGroupsCollapsed[d.label]??!1,$=d.tabs.some(x=>x===e.tab);return r`
            <div class="nav-group ${v&&!$?"nav-group--collapsed":""}">
              <button
                class="nav-label"
                @click=${()=>{const x={...e.settings.navGroupsCollapsed};x[d.label]=!v,e.applySettings({...e.settings,navGroupsCollapsed:x})}}
                aria-expanded=${!v}
              >
      ...
      <main class="content ${a?"content--chat":""}">
        ...
        ${e.tab==="agents"?Gg({loading:e.agentsLoading,error:e.agentsError,agentsList:e.agentsList,selectedAgentId:f,activePanel:e.agentsPanel,configForm:h,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,channelsLoading:e.channelsLoading,channelsError:e.channelsError,channelsSnapshot:e.channelsSnapshot,channelsLastSuccess:e.channelsLastSuccess,cronLoading:e.cronLoading,cronStatus:e.cronStatus,cronJobs:e.cronJobs,cronError:e.cronError,agentFilesLoading:e.agentFilesLoading,agentFilesError:e.agentFilesError,agentFilesList:e.agentFilesList,agentFileActive:e.agentFileActive,agentFileContents:e.agentFileContents,agentFileDrafts:e.agentFileDrafts,agentFileSaving:e.agentFileSaving,agentIdentityLoading:e.agentIdentityLoading,agentIdentityError:e.agentIdentityError,agentIdentityById:e.agentIdentityById,agentSkillsLoading:e.agentSkillsLoading,agentSkillsReport:e.agentSkillsReport,agentSkillsError:e.agentSkillsError,agentSkillsAgentId:e.agentSkillsAgentId,skillsFilter:e.skillsFilter,onRefresh:async()=>{await Mi(e);const d=e.agentsList?.agents?.map(v=>v.id)??[];d.length>0&&vr(e,d)},onSelectAgent:d=>{e.agentsSelectedId!==d&&(e.agentsSelectedId=d,e.agentFilesList=null,e.agentFilesError=null,e.agentFilesLoading=!1,e.agentFileActive=null,e.agentFileContents={},e.agentFileDrafts={},e.agentSkillsReport=null,e.agentSkillsError=null,e.agentSkillsAgentId=null,hr(e,d),e.agentsPanel==="files"&&Es(e,d),e.agentsPanel==="skills"&&Ln(e,d))},onSelectPanel:d=>{e.agentsPanel=d,d==="files"&&f&&e.agentFilesList?.agentId!==f&&(e.agentFilesList=null,e.agentFilesError=null,e.agentFileActive=null,e.agentFileContents={},e.agentFileDrafts={},Es(e,f)),d==="skills"&&f&&Ln(e,f),d==="channels"&&ye(e,!1),d==="cron"&&e.loadCron()},onLoadFiles:d=>{(async()=>(await Es(e,d),e.agentFileActive&&await no(e,d,e.agentFileActive)))()},onSelectFile:d=>{e.agentFileActive=d,f&&no(e,f,d)},onFileDraftChange:(d,v)=>{e.agentFileDrafts={...e.agentFileDrafts,[d]:v}},onFileReset:d=>{const v=e.agentFileContents[d]??"";e.agentFileDrafts={...e.agentFileDrafts,[d]:v}},onFileSave:d=>{if(!f)return;const v=e.agentFileDrafts[d]??e.agentFileContents[d]??"";Eg(e,f,d,v)},onToolsProfileChange:(d,v,$)=>{if(!h)return;const x=h.agents?.list;if(!Array.isArray(x))return;const y=x.findIndex(A=>A&&typeof A=="object"&&"id"in A&&A.id===d);if(y<0)return;const C=["agents","list",y,"tools"];v?$e(e,[...C,"profile"],v):Ue(e,[...C,"profile"]),$&&Ue(e,[...C,"allow"])},onToolsOverridesChange:(d,v,$)=>{if(!h)return;const x=h.agents?.list;if(!Array.isArray(x))return;const y=x.findIndex(A=>A&&typeof A=="object"&&"id"in A&&A.id===d);if(y<0)return;const C=["agents","list",y,"tools"];v.length>0?$e(e,[...C,"alsoAllow"],v):Ue(e,[...C,"alsoAllow"]),$.length>0?$e(e,[...C,"deny"],$):Ue(e,[...C,"deny"])},onConfigReload:()=>Ee(e),onConfigSave:()=>En(e),onChannelsRefresh:()=>ye(e,!1),onCronRefresh:()=>e.loadCron(),onSkillsFilterChange:d=>e.skillsFilter=d,onSkillsRefresh:()=>{f&&Ln(e,f)},onAgentSkillToggle:(d,v,$)=>{if(!h)return;const x=h.agents?.list;if(!Array.isArray(x))return;const y=x.findIndex(K=>K&&typeof K=="object"&&"id"in K&&K.id===d);if(y<0)return;const C=x[y],A=v.trim();if(!A)return;const T=e.agentSkillsReport?.skills?.map(K=>K.name).filter(Boolean)??[],I=(Array.isArray(C.skills)?C.skills.map(K=>String(K).trim()).filter(Boolean):void 0)??T,q=new Set(I);$?q.add(A):q.delete(A),$e(e,["agents","list",y,"skills"],[...q])},onAgentSkillsClear:d=>{if(!h)return;const v=h.agents?.list;if(!Array.isArray(v))return;const $=v.findIndex(x=>x&&typeof x=="object"&&"id"in x&&x.id===d);$<0||Ue(e,["agents","list",$,"skills"])},onAgentSkillsDisableAll:d=>{if(!h)return;const v=h.agents?.list;if(!Array.isArray(v))return;const $=v.findIndex(x=>x&&typeof x=="object"&&"id"in x&&x.id===d);$<0||$e(e,["agents","list",$,"skills"],[])},onModelChange:(d,v)=>{if(!h)return;const $=h.agents?.list;if(!Array.isArray($))return;const x=$.findIndex(T=>T&&typeof T=="object"&&"id"in T&&T.id===d);if(x<0)return;const y=["agents","list",x,"model"];if(!v){Ue(e,y);return}const A=$[x]?.model;if(A&&typeof A=="object"&&!Array.isArray(A)){const T=A.fallbacks,_={primary:v,...Array.isArray(T)?{fallbacks:T}:{}};$e(e,y,_)}else $e(e,y,v)},onModelFallbacksChange:(d,v)=>{if(!h)return;const $=h.agents?.list;if(!Array.isArray($))return;const x=$.findIndex(K=>K&&typeof K=="object"&&"id"in K&&K.id===d);if(x<0)return;const y=["agents","list",x,"model"],C=$[x],A=v.map(K=>K.trim()).filter(Boolean),T=C.model,I=(()=>{if(typeof T=="string")return T.trim()||null;if(T&&typeof T=="object"&&!Array.isArray(T)){const K=T.primary;if(typeof K=="string")return K.trim()||null}return null})();if(A.length===0){I?$e(e,y,I):Ue(e,y);return}$e(e,y,I?{primary:I,fallbacks:A}:{fallbacks:A})}}):m}

        ${e.tab==="skills"?um({loading:e.skillsLoading,report:e.skillsReport,error:e.skillsError,filter:e.skillsFilter,edits:e.skillEdits,messages:e.skillMessages,busyKey:e.skillsBusyKey,onFilterChange:d=>e.skillsFilter=d,onRefresh:()=>rn(e,{clearMessages:!0}),onToggle:(d,v)=>mu(e,d,v),onEdit:(d,v)=>vu(e,d,v),onSaveKey:d=>bu(e,d),onInstall:(d,v,$)=>yu(e,d,v,$)}):m}

        ${e.tab==="nodes"?_v({loading:e.nodesLoading,nodes:e.nodes,devicesLoading:e.devicesLoading,devicesError:e.devicesError,devicesList:e.devicesList,configForm:e.configForm??e.configSnapshot?.config,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,configFormMode:e.configFormMode,execApprovalsLoading:e.execApprovalsLoading,execApprovalsSaving:e.execApprovalsSaving,execApprovalsDirty:e.execApprovalsDirty,execApprovalsSnapshot:e.execApprovalsSnapshot,execApprovalsForm:e.execApprovalsForm,execApprovalsSelectedAgent:e.execApprovalsSelectedAgent,execApprovalsTarget:e.execApprovalsTarget,execApprovalsTargetNodeId:e.execApprovalsTargetNodeId,onRefresh:()=>Qn(e),onDevicesRefresh:()=>Ze(e),onDeviceApprove:d=>ou(e,d),onDeviceReject:d=>ru(e,d),onDeviceRotate:(d,v,$)=>lu(e,{deviceId:d,role:v,scopes:$}),onDeviceRevoke:(d,v)=>cu(e,{deviceId:d,role:v}),onLoadConfig:()=>Ee(e),onLoadExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return Ni(e,d)},onBindDefault:d=>{d?$e(e,["tools","exec","node"],d):Ue(e,["tools","exec","node"])},onBindAgent:(d,v)=>{const $=["agents","list",d,"tools","exec","node"];v?$e(e,$,v):Ue(e,$)},onSaveBindings:()=>En(e),onExecApprovalsTargetChange:(d,v)=>{e.execApprovalsTarget=d,e.execApprovalsTargetNodeId=v,e.execApprovalsSnapshot=null,e.execApprovalsForm=null,e.execApprovalsDirty=!1,e.execApprovalsSelectedAgent=null},onExecApprovalsSelectAgent:d=>{e.execApprovalsSelectedAgent=d},onExecApprovalsPatch:(d,v)=>fu(e,d,v),onExecApprovalsRemove:d=>hu(e,d),onSaveExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return pu(e,d)}}):m}
  ...
  `}var tb=Object.defineProperty,nb=Object.getOwnPropertyDescriptor,k=(e,t,n,s)=>{for(var i=s>1?void 0:s?nb(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(s?o(t,n,i):o(i))||i);return s&&i&&tb(t,n,i),i};const Ks=og();function sb(){if(!window.location.search)return!1;const t=new URLSearchParams(window.location.search).get("onboarding");if(!t)return!1;const n=t.trim().toLowerCase();return n==="1"||n==="true"||n==="yes"||n==="on"}let w=class extends Ct{constructor(){super(...arguments),this.settings=Cu(),this.password="",this.tab="chat",this.onboarding=sb(),this.connected=!1,this.theme=this.settings.theme??"system",this.themeResolved="dark",this.hello=null,this.lastError=null,this.eventLog=[],this.eventLogBuffer=[],this.toolStreamSyncTimer=null,this.sidebarCloseTimer=null,this.assistantName=Ks.name,this.assistantAvatar=Ks.avatar,this.assistantAgentId=Ks.agentId??null,this.sessionKey=this.settings.sessionKey,this.chatLoading=!1,this.chatSending=!1,this.chatMessage="",this.chatMessages=[],this.chatToolMessages=[],this.chatStream=null,this.chatStreamStartedAt=null,this.chatRunId=null,this.compactionStatus=null,this.chatAvatarUrl=null,this.chatThinkingLevel=null,this.chatQueue=[],this.chatAttachments=[],this.sidebarOpen=!1,this.sidebarContent=null,this.sidebarError=null,this.splitRatio=this.settings.splitRatio,this.nodesLoading=!1,this.nodes=[],this.devicesLoading=!1,this.devicesError=null,this.devicesList=null,this.execApprovalsLoading=!1,this.execApprovalsSaving=!1,this.execApprovalsDirty=!1,this.execApprovalsSnapshot=null,this.execApprovalsForm=null,this.execApprovalsSelectedAgent=null,this.execApprovalsTarget="gateway",this.execApprovalsTargetNodeId=null,this.execApprovalQueue=[],this.execApprovalBusy=!1,this.execApprovalError=null,this.pendingGatewayUrl=null,this.configLoading=!1,this.configRaw=`{
}
`,this.configRawOriginal="",this.configValid=null,this.configIssues=[],this.configSaving=!1,this.configApplying=!1,this.updateRunning=!1,this.applySessionKey=this.settings.lastActiveSessionKey,this.configSnapshot=null,this.configSchema=null,this.configSchemaVersion=null,this.configSchemaLoading=!1,this.configUiHints={},this.configForm=null,this.configFormOriginal=null,this.configFormDirty=!1,this.configFormMode="form",this.configSearchQuery="",this.configActiveSection=null,this.configActiveSubsection=null,this.channelsLoading=!1,this.channelsSnapshot=null,this.channelsError=null,this.channelsLastSuccess=null,this.whatsappLoginMessage=null,this.whatsappLoginQrDataUrl=null,this.whatsappLoginConnected=null,this.whatsappBusy=!1,this.nostrProfileFormState=null,this.nostrProfileAccountId=null,this.presenceLoading=!1,this.presenceEntries=[],this.presenceError=null,this.presenceStatus=null,this.agentsLoading=!1,this.agentsList=null,this.agentsError=null,this.sessionsLoading=!1,this.sessionsResult=null,this.sessionsError=null,this.sessionsFilterActive="",this.sessionsFilterLimit="120",this.sessionsIncludeGlobal=!0,this.sessionsIncludeUnknown=!1,this.usageLoading=!1,this.usageResult=null,this.usageCostSummary=null,this.usageError=null,this.usageStartDate=(()=>{const e=new Date;return e.setDate(e.getDate()-30),`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`})(),this.usageEndDate=(()=>{const e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`})(),this.usageSelectedSessions=[],this.usageSelectedDays=[],this.usageSelectedHours=[],this.usageChartMode="tokens",this.usageDailyChartMode="by-type",this.usageTimeSeriesMode="per-turn",this.usageTimeSeriesBreakdownMode="by-type",this.usageTimeSeries=null,this.usageTimeSeriesLoading=!1,this.usageSessionLogs=null,this.usageSessionLogsLoading=!1,this.usageSessionLogsExpanded=!1,this.usageQuery="",this.usageQueryDraft="",this.usageSessionSort="recent",this.usageSessionSortDir="desc",this.usageRecentSessions=[],this.usageTimeZone="local",this.usageContextExpanded=!1,this.usageHeaderPinned=!1,this.usageSessionsTab="all",this.usageVisibleColumns=["channel","agent","provider","model","messages","tools","errors","duration"],this.usageLogFilterRoles=[],this.usageLogFilterTools=[],this.usageLogFilterHasTools=!1,this.usageLogFilterQuery="",this.usageQueryDebounceTimer=null,this.cronLoading=!1,this.cronJobs=[],this.cronStatus=null,this.cronError=null,this.cronForm={...Yu},this.cronRunsJobId=null,this.cronRuns=[],this.cronBusy=!1,this.skillsLoading=!1,this.skillsReport=null,this.skillsError=null,this.skillsFilter="",this.skillEdits={},this.skillsBusyKey=null,this.skillMessages={},this.debugLoading=!1,this.debugStatus=null,this.debugHealth=null,this.debugModels=[],this.debugHeartbeat=null,this.debugCallMethod="",this.debugCallParams="{}",this.debugCallResult=null,this.debugCallError=null,this.logsLoading=!1,this.logsError=null,this.logsFile=null,this.logsEntries=[],this.logsFilterText="",this.logsLevelFilters={...Qu},this.logsAutoFollow=!0,this.logsTruncated=!1,this.logsCursor=null,this.logsLastFetchAt=null,this.logsLimit=500,this.logsMaxBytes=25e4,this.logsAtBottom=!0,this.client=null,this.chatScrollFrame=null,this.chatScrollTimeout=null,this.chatHasAutoScrolled=!1,this.chatUserNearBottom=!0,this.chatNewMessagesBelow=!1,this.nodesPollInterval=null,this.logsPollInterval=null,this.debugPollInterval=null,this.logsScrollFrame=null,this.toolStreamById=new Map,this.toolStreamOrder=[],this.refreshSessionsAfterChat=new Set,this.basePath="",this.popStateHandler=()=>Bu(this),this.themeMedia=null,this.themeMediaHandler=null,this.topbarObserver=null}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),ug(this)}firstUpdated(){gg(this)}disconnectedCallback(){pg(this),super.disconnectedCallback()}updated(e){fg(this,e)}connect(){Jr(this)}handleChatScroll(e){hd(this,e)}handleLogsScroll(e){vd(this,e)}exportLogs(e,t){md(e,t)}resetToolStream(){Ai(this)}resetChatScroll(){Ka(this)}scrollToBottom(){Ka(this),an(this,!0)}async loadAssistantIdentity(){await Xr(this)}applySettings(e){ht(this,e)}setTab(e){Iu(this,e)}setTheme(e,t){Ru(this,e,t)}async loadOverview(){await Kr(this)}async loadCron(){await Nn(this)}async handleAbortChat(){await Wr(this)}removeQueuedMessage(e){ju(this,e)}async handleSendChat(e,t){await qu(this,e,t)}async handleWhatsAppStart(e){await Lc(this,e)}async handleWhatsAppWait(){await Mc(this)}async handleWhatsAppLogout(){await Ic(this)}async handleChannelConfigSave(){await Rc(this)}async handleChannelConfigReload(){await Pc(this)}handleNostrProfileEdit(e,t){Oc(this,e,t)}handleNostrProfileCancel(){Nc(this)}handleNostrProfileFieldChange(e,t){Bc(this,e,t)}async handleNostrProfileSave(){await Uc(this)}async handleNostrProfileImport(){await Hc(this)}handleNostrProfileToggleAdvanced(){zc(this)}async handleExecApprovalDecision(e){const t=this.execApprovalQueue[0];if(!(!t||!this.client||this.execApprovalBusy)){this.execApprovalBusy=!0,this.execApprovalError=null;try{await this.client.request("exec.approval.resolve",{id:t.id,decision:e}),this.execApprovalQueue=this.execApprovalQueue.filter(n=>n.id!==t.id)}catch(n){this.execApprovalError=`Exec approval failed: ${String(n)}`}finally{this.execApprovalBusy=!1}}}handleGatewayUrlConfirm(){const e=this.pendingGatewayUrl;e&&(this.pendingGatewayUrl=null,ht(this,{...this.settings,gatewayUrl:e}),this.connect())}handleGatewayUrlCancel(){this.pendingGatewayUrl=null}handleOpenSidebar(e){this.sidebarCloseTimer!=null&&(window.clearTimeout(this.sidebarCloseTimer),this.sidebarCloseTimer=null),this.sidebarContent=e,this.sidebarError=null,this.sidebarOpen=!0}handleCloseSidebar(){this.sidebarOpen=!1,this.sidebarCloseTimer!=null&&window.clearTimeout(this.sidebarCloseTimer),this.sidebarCloseTimer=window.setTimeout(()=>{this.sidebarOpen||(this.sidebarContent=null,this.sidebarError=null,this.sidebarCloseTimer=null)},200)}handleSplitRatioChange(e){const t=Math.max(.4,Math.min(.7,e));this.splitRatio=t,this.applySettings({...this.settings,splitRatio:t})}render(){return eb(this)}};k([S()],w.prototype,"settings",2);k([S()],w.prototype,"password",2);k([S()],w.prototype,"tab",2);k([S()],w.prototype,"onboarding",2);k([S()],w.prototype,"connected",2);k([S()],w.prototype,"theme",2);k([S()],w.prototype,"themeResolved",2);k([S()],w.prototype,"hello",2);k([S()],w.prototype,"lastError",2);k([S()],w.prototype,"eventLog",2);k([S()],w.prototype,"assistantName",2);k([S()],w.prototype,"assistantAvatar",2);k([S()],w.prototype,"assistantAgentId",2);k([S()],w.prototype,"sessionKey",2);k([S()],w.prototype,"chatLoading",2);k([S()],w.prototype,"chatSending",2);k([S()],w.prototype,"chatMessage",2);k([S()],w.prototype,"chatMessages",2);k([S()],w.prototype,"chatToolMessages",2);k([S()],w.prototype,"chatStream",2);k([S()],w.prototype,"chatStreamStartedAt",2);k([S()],w.prototype,"chatRunId",2);k([S()],w.prototype,"compactionStatus",2);k([S()],w.prototype,"chatAvatarUrl",2);k([S()],w.prototype,"chatThinkingLevel",2);k([S()],w.prototype,"chatQueue",2);k([S()],w.prototype,"chatAttachments",2);k([S()],w.prototype,"sidebarOpen",2);k([S()],w.prototype,"sidebarContent",2);k([S()],w.prototype,"sidebarError",2);k([S()],w.prototype,"splitRatio",2);k([S()],w.prototype,"nodesLoading",2);k([S()],w.prototype,"nodes",2);k([S()],w.prototype,"devicesLoading",2);k([S()],w.prototype,"devicesError",2);k([S()],w.prototype,"devicesList",2);k([S()],w.prototype,"execApprovalsLoading",2);k([S()],w.prototype,"execApprovalsSaving",2);k([S()],w.prototype,"execApprovalsDirty",2);k([S()],w.prototype,"execApprovalsSnapshot",2);k([S()],w.prototype,"execApprovalsForm",2);k([S()],w.prototype,"execApprovalsSelectedAgent",2);k([S()],w.prototype,"execApprovalsTarget",2);k([S()],w.prototype,"execApprovalsTargetNodeId",2);k([S()],w.prototype,"execApprovalQueue",2);k([S()],w.prototype,"execApprovalBusy",2);k([S()],w.prototype,"execApprovalError",2);k([S()],w.prototype,"pendingGatewayUrl",2);k([S()],w.prototype,"configLoading",2);k([S()],w.prototype,"configRaw",2);k([S()],w.prototype,"configRawOriginal",2);k([S()],w.prototype,"configValid",2);k([S()],w.prototype,"configIssues",2);k([S()],w.prototype,"configSaving",2);k([S()],w.prototype,"configApplying",2);k([S()],w.prototype,"updateRunning",2);k([S()],w.prototype,"applySessionKey",2);k([S()],w.prototype,"configSnapshot",2);k([S()],w.prototype,"configSchema",2);k([S()],w.prototype,"configSchemaVersion",2);k([S()],w.prototype,"configSchemaLoading",2);k([S()],w.prototype,"configUiHints",2);k([S()],w.prototype,"configForm",2);k([S()],w.prototype,"configFormOriginal",2);k([S()],w.prototype,"configFormDirty",2);k([S()],w.prototype,"configFormMode",2);k([S()],w.prototype,"configSearchQuery",2);k([S()],w.prototype,"configActiveSection",2);k([S()],w.prototype,"configActiveSubsection",2);k([S()],w.prototype,"channelsLoading",2);k([S()],w.prototype,"channelsSnapshot",2);k([S()],w.prototype,"channelsError",2);k([S()],w.prototype,"channelsLastSuccess",2);k([S()],w.prototype,"whatsappLoginMessage",2);k([S()],w.prototype,"whatsappLoginQrDataUrl",2);k([S()],w.prototype,"whatsappLoginConnected",2);k([S()],w.prototype,"whatsappBusy",2);k([S()],w.prototype,"nostrProfileFormState",2);k([S()],w.prototype,"nostrProfileAccountId",2);k([S()],w.prototype,"presenceLoading",2);k([S()],w.prototype,"presenceEntries",2);k([S()],w.prototype,"presenceError",2);k([S()],w.prototype,"presenceStatus",2);k([S()],w.prototype,"agentsLoading",2);k([S()],w.prototype,"agentsList",2);k([S()],w.prototype,"agentsError",2);k([S()],w.prototype,"sessionsLoading",2);k([S()],w.prototype,"sessionsResult",2);k([S()],w.prototype,"sessionsError",2);k([S()],w.prototype,"sessionsFilterActive",2);k([S()],w.prototype,"sessionsFilterLimit",2);k([S()],w.prototype,"sessionsIncludeGlobal",2);k([S()],w.prototype,"sessionsIncludeUnknown",2);k([S()],w.prototype,"usageLoading",2);k([S()],w.prototype,"usageResult",2);k([S()],w.prototype,"usageCostSummary",2);k([S()],w.prototype,"usageError",2);k([S()],w.prototype,"usageStartDate",2);k([S()],w.prototype,"usageEndDate",2);k([S()],w.prototype,"usageSelectedSessions",2);k([S()],w.prototype,"usageSelectedDays",2);k([S()],w.prototype,"usageSelectedHours",2);k([S()],w.prototype,"usageChartMode",2);k([S()],w.prototype,"usageDailyChartMode",2);k([S()],w.prototype,"usageTimeSeriesMode",2);k([S()],w.prototype,"usageTimeSeriesBreakdownMode",2);k([S()],w.prototype,"usageTimeSeries",2);k([S()],w.prototype,"usageTimeSeriesLoading",2);k([S()],w.prototype,"usageSessionLogs",2);k([S()],w.prototype,"usageSessionLogsLoading",2);k([S()],w.prototype,"usageSessionLogsExpanded",2);k([S()],w.prototype,"usageQuery",2);k([S()],w.prototype,"usageQueryDraft",2);k([S()],w.prototype,"usageSessionSort",2);k([S()],w.prototype,"usageSessionSortDir",2);k([S()],w.prototype,"usageRecentSessions",2);k([S()],w.prototype,"usageTimeZone",2);k([S()],w.prototype,"usageContextExpanded",2);k([S()],w.prototype,"usageHeaderPinned",2);k([S()],w.prototype,"usageSessionsTab",2);k([S()],w.prototype,"usageVisibleColumns",2);k([S()],w.prototype,"usageLogFilterRoles",2);k([S()],w.prototype,"usageLogFilterTools",2);k([S()],w.prototype,"usageLogFilterHasTools",2);k([S()],w.prototype,"usageLogFilterQuery",2);k([S()],w.prototype,"cronLoading",2);k([S()],w.prototype,"cronJobs",2);k([S()],w.prototype,"cronStatus",2);k([S()],w.prototype,"cronError",2);k([S()],w.prototype,"cronForm",2);k([S()],w.prototype,"cronRunsJobId",2);k([S()],w.prototype,"cronRuns",2);k([S()],w.prototype,"cronBusy",2);k([S()],w.prototype,"skillsLoading",2);k([S()],w.prototype,"skillsReport",2);k([S()],w.prototype,"skillsError",2);k([S()],w.prototype,"skillsFilter",2);k([S()],w.prototype,"skillEdits",2);k([S()],w.prototype,"skillsBusyKey",2);k([S()],w.prototype,"skillMessages",2);k([S()],w.prototype,"debugLoading",2);k([S()],w.prototype,"debugStatus",2);k([S()],w.prototype,"debugHealth",2);k([S()],w.prototype,"debugModels",2);k([S()],w.prototype,"debugHeartbeat",2);k([S()],w.prototype,"debugCallMethod",2);k([S()],w.prototype,"debugCallParams",2);k([S()],w.prototype,"debugCallResult",2);k([S()],w.prototype,"debugCallError",2);k([S()],w.prototype,"logsLoading",2);k([S()],w.prototype,"logsError",2);k([S()],w.prototype,"logsFile",2);k([S()],w.prototype,"logsEntries",2);k([S()],w.prototype,"logsFilterText",2);k([S()],w.prototype,"logsLevelFilters",2);k([S()],w.prototype,"logsAutoFollow",2);k([S()],w.prototype,"logsTruncated",2);k([S()],w.prototype,"logsCursor",2);k([S()],w.prototype,"logsLastFetchAt",2);k([S()],w.prototype,"logsLimit",2);k([S()],w.prototype,"logsMaxBytes",2);k([S()],w.prototype,"logsAtBottom",2);k([S()],w.prototype,"chatNewMessagesBelow",2);w=k([ir("openclaw-app")],w);
//# sourceMappingURL=index-CJEJ7usA.js.map
